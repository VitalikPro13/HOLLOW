...
| Document | What it is |
|---|---|
| `reference/HOLLOW_DESIGN_LANGUAGE.md` | The design language: tokens, type roles, the gap ramp, the two label components, the button-variant rule, motion, states and the forbidden list. Enforced by the `hollow-ui` skill and `test/design_language_guard_test.dart`. |
