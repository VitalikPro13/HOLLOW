...
class RegisteredElementWidget extends ProxyWidget {
  ...
  /// HOLLOW PATCH: the item index this element currently displays. Position
  /// reporting reads this field instead of parsing `key as ValueKey<int>`,
  /// which frees the key to carry item IDENTITY (so elements can be moved
  /// across index slots via findChildIndexCallback instead of remounting).
  final int index;
