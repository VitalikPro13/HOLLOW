...
class ScrollablePositionedList extends StatefulWidget {
  ...
  /// null if the item is gone. When provided, list elements are moved across
  /// index slots instead of being torn down and re-inflated whenever indices
  /// shift (e.g. a reverse chat list where every new message shifts all items
  /// by one — without this, every visible row remounts on every message).
