...
/// One listing, big enough to judge: the art at a size worth looking at, who
/// drew it, what the licence says, and either Buy (which leaves for the
/// browser) or Wear it (when the pack is already imported).
