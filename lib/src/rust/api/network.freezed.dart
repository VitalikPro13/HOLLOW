...
return channelNotificationHint(_that.serverId,_that.channelId,_that.fromPeer,_that.hasEveryone,_that.mentionedNames,_that.isReply);case NetworkEvent_TypingStarted() when typingStarted != null:
...
return channelNotificationHint(_that.serverId,_that.channelId,_that.fromPeer,_that.hasEveryone,_that.mentionedNames,_that.isReply);case NetworkEvent_TypingStarted():
...
class NetworkEvent_ChannelNotificationHint extends NetworkEvent {
  const NetworkEvent_ChannelNotificationHint({required this.serverId, required this.channelId, required this.fromPeer, required this.hasEveryone, required final  List<String> mentionedNames, required this.isReply}): _mentionedNames = mentionedNames,super._();
...
@override
int get hashCode => Object.hash(runtimeType,serverId,channelId,fromPeer,hasEveryone,const DeepCollectionEquality().hash(_mentionedNames),isReply);

@override
String toString() {
  return 'NetworkEvent.channelNotificationHint(serverId: $serverId, channelId: $channelId, fromPeer: $fromPeer, hasEveryone: $hasEveryone, mentionedNames: $mentionedNames, isReply: $isReply)';
}
...
@useResult
$Res call({
 String serverId, String channelId, String fromPeer, bool hasEveryone, List<String> mentionedNames, bool isReply
});
...
/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? serverId = null,Object? channelId = null,Object? fromPeer = null,Object? hasEveryone = null,Object? mentionedNames = null,Object? isReply = null,}) {
