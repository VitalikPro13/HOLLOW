...
return serverUpdated(_that);case NetworkEvent_EmoteAssetsReceived() when emoteAssetsReceived != null:
return emoteAssetsReceived(_that);case NetworkEvent_PersonalEmotesUpdated() when personalEmotesUpdated != null:
return personalEmotesUpdated(_that);case NetworkEvent_ChannelAdded() when channelAdded != null:
...
return serverJoinFailed(_that);case NetworkEvent_ServerJoinParked() when serverJoinParked != null:
return serverJoinParked(_that);case NetworkEvent_PendingJoinUpdated() when pendingJoinUpdated != null:
return pendingJoinUpdated(_that);case NetworkEvent_MessageSyncStarted() when messageSyncStarted != null:
...
return profileUpdated(_that);case NetworkEvent_DeviceListUpdated() when deviceListUpdated != null:
return deviceListUpdated(_that);case NetworkEvent_ReadMarkersReceived() when readMarkersReceived != null:
return readMarkersReceived(_that);case NetworkEvent_SecurityAlert() when securityAlert != null:
return securityAlert(_that);case NetworkEvent_SelfRevoked() when selfRevoked != null:
return selfRevoked(_that);case NetworkEvent_DestroyReceived() when destroyReceived != null:
return destroyReceived(_that);case NetworkEvent_IdentityDestroyedByFriend() when identityDestroyedByFriend != null:
return identityDestroyedByFriend(_that);case NetworkEvent_ChannelMessageEdited() when channelMessageEdited != null:
return channelMessageEdited(_that);case NetworkEvent_DmMessageEdited() when dmMessageEdited != null:
return dmMessageEdited(_that);case NetworkEvent_ChannelLinkPreviewUpdated() when channelLinkPreviewUpdated != null:
return channelLinkPreviewUpdated(_that);case NetworkEvent_DmLinkPreviewUpdated() when dmLinkPreviewUpdated != null:
return dmLinkPreviewUpdated(_that);case NetworkEvent_ChannelMessageDeleted() when channelMessageDeleted != null:
...
return friendRemoved(_that);case NetworkEvent_FriendsBackfilled() when friendsBackfilled != null:
return friendsBackfilled(_that);case NetworkEvent_NicknameClaimed() when nicknameClaimed != null:
return nicknameClaimed(_that);case NetworkEvent_NicknameReleased() when nicknameReleased != null:
return nicknameReleased(_that);case NetworkEvent_NicknameClaimFailed() when nicknameClaimFailed != null:
return nicknameClaimFailed(_that);case NetworkEvent_NicknameResolveFailed() when nicknameResolveFailed != null:
return nicknameResolveFailed(_that);case NetworkEvent_RelayDisconnected() when relayDisconnected != null:
return relayDisconnected(_that);case NetworkEvent_RelayConnected() when relayConnected != null:
return relayConnected(_that);case NetworkEvent_RelayConnecting() when relayConnecting != null:
return relayConnecting(_that);case NetworkEvent_ChannelNotificationHint() when channelNotificationHint != null:
...
return fileFailed(_that);case NetworkEvent_FileAvailability() when fileAvailability != null:
return fileAvailability(_that);case NetworkEvent_TurnCredentials() when turnCredentials != null:
return turnCredentials(_that);case NetworkEvent_LinkCodeClaimed() when linkCodeClaimed != null:
return linkCodeClaimed(_that);case NetworkEvent_LinkCodeError() when linkCodeError != null:
return linkCodeError(_that);case NetworkEvent_SiblingLinkAvailable() when siblingLinkAvailable != null:
return siblingLinkAvailable(_that);case NetworkEvent_LinkProgress() when linkProgress != null:
return linkProgress(_that);case NetworkEvent_LinkComplete() when linkComplete != null:
return linkComplete(_that);case NetworkEvent_LinkFailed() when linkFailed != null:
return linkFailed(_that);case NetworkEvent_LinkPushComplete() when linkPushComplete != null:
return linkPushComplete(_that);case NetworkEvent_ShardStored() when shardStored != null:
...
return voiceChannelSignal(_that);case NetworkEvent_ForwarderSignal() when forwarderSignal != null:
return forwarderSignal(_that);case NetworkEvent_MediaForwarderInfo() when mediaForwarderInfo != null:
return mediaForwarderInfo(_that);case NetworkEvent_GossipConnect() when gossipConnect != null:
...
return gossipRelayFile(_that);case NetworkEvent_GossipRelayOp() when gossipRelayOp != null:
return gossipRelayOp(_that);case NetworkEvent_VoiceChannelModeChanged() when voiceChannelModeChanged != null:
return voiceChannelModeChanged(_that);case NetworkEvent_MlsEpochChanged() when mlsEpochChanged != null:
return mlsEpochChanged(_that);case NetworkEvent_ConferenceJoinRequestReceived() when conferenceJoinRequestReceived != null:
return conferenceJoinRequestReceived(_that);case NetworkEvent_ConferenceJoinDenied() when conferenceJoinDenied != null:
return conferenceJoinDenied(_that);case NetworkEvent_ConferenceLobbyInfo() when conferenceLobbyInfo != null:
return conferenceLobbyInfo(_that);case NetworkEvent_ConferenceAdmitted() when conferenceAdmitted != null:
return conferenceAdmitted(_that);case NetworkEvent_ConferenceChatMessage() when conferenceChatMessage != null:
return conferenceChatMessage(_that);case NetworkEvent_ConferenceEnded() when conferenceEnded != null:
return conferenceEnded(_that);case NetworkEvent_ConferenceKicked() when conferenceKicked != null:
return conferenceKicked(_that);case NetworkEvent_RecoveryPoolCreated() when recoveryPoolCreated != null:
...
return serverUpdated(_that);case NetworkEvent_EmoteAssetsReceived():
return emoteAssetsReceived(_that);case NetworkEvent_PersonalEmotesUpdated():
return personalEmotesUpdated(_that);case NetworkEvent_ChannelAdded():
...
return serverJoinFailed(_that);case NetworkEvent_ServerJoinParked():
return serverJoinParked(_that);case NetworkEvent_PendingJoinUpdated():
return pendingJoinUpdated(_that);case NetworkEvent_MessageSyncStarted():
...
return profileUpdated(_that);case NetworkEvent_DeviceListUpdated():
return deviceListUpdated(_that);case NetworkEvent_ReadMarkersReceived():
return readMarkersReceived(_that);case NetworkEvent_SecurityAlert():
return securityAlert(_that);case NetworkEvent_SelfRevoked():
return selfRevoked(_that);case NetworkEvent_DestroyReceived():
return destroyReceived(_that);case NetworkEvent_IdentityDestroyedByFriend():
return identityDestroyedByFriend(_that);case NetworkEvent_ChannelMessageEdited():
return channelMessageEdited(_that);case NetworkEvent_DmMessageEdited():
return dmMessageEdited(_that);case NetworkEvent_ChannelLinkPreviewUpdated():
return channelLinkPreviewUpdated(_that);case NetworkEvent_DmLinkPreviewUpdated():
return dmLinkPreviewUpdated(_that);case NetworkEvent_ChannelMessageDeleted():
...
return friendRemoved(_that);case NetworkEvent_FriendsBackfilled():
return friendsBackfilled(_that);case NetworkEvent_NicknameClaimed():
return nicknameClaimed(_that);case NetworkEvent_NicknameReleased():
return nicknameReleased(_that);case NetworkEvent_NicknameClaimFailed():
return nicknameClaimFailed(_that);case NetworkEvent_NicknameResolveFailed():
return nicknameResolveFailed(_that);case NetworkEvent_RelayDisconnected():
return relayDisconnected(_that);case NetworkEvent_RelayConnected():
return relayConnected(_that);case NetworkEvent_RelayConnecting():
return relayConnecting(_that);case NetworkEvent_ChannelNotificationHint():
...
return fileFailed(_that);case NetworkEvent_FileAvailability():
return fileAvailability(_that);case NetworkEvent_TurnCredentials():
return turnCredentials(_that);case NetworkEvent_LinkCodeClaimed():
return linkCodeClaimed(_that);case NetworkEvent_LinkCodeError():
return linkCodeError(_that);case NetworkEvent_SiblingLinkAvailable():
return siblingLinkAvailable(_that);case NetworkEvent_LinkProgress():
return linkProgress(_that);case NetworkEvent_LinkComplete():
return linkComplete(_that);case NetworkEvent_LinkFailed():
return linkFailed(_that);case NetworkEvent_LinkPushComplete():
return linkPushComplete(_that);case NetworkEvent_ShardStored():
...
return voiceChannelSignal(_that);case NetworkEvent_ForwarderSignal():
return forwarderSignal(_that);case NetworkEvent_MediaForwarderInfo():
return mediaForwarderInfo(_that);case NetworkEvent_GossipConnect():
...
return gossipRelayFile(_that);case NetworkEvent_GossipRelayOp():
return gossipRelayOp(_that);case NetworkEvent_VoiceChannelModeChanged():
return voiceChannelModeChanged(_that);case NetworkEvent_MlsEpochChanged():
return mlsEpochChanged(_that);case NetworkEvent_ConferenceJoinRequestReceived():
return conferenceJoinRequestReceived(_that);case NetworkEvent_ConferenceJoinDenied():
return conferenceJoinDenied(_that);case NetworkEvent_ConferenceLobbyInfo():
return conferenceLobbyInfo(_that);case NetworkEvent_ConferenceAdmitted():
return conferenceAdmitted(_that);case NetworkEvent_ConferenceChatMessage():
return conferenceChatMessage(_that);case NetworkEvent_ConferenceEnded():
return conferenceEnded(_that);case NetworkEvent_ConferenceKicked():
return conferenceKicked(_that);case NetworkEvent_RecoveryPoolCreated():
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( DiscoveredPeer peer)?  peerDiscovered,TResult Function( String peerId)?  peerExpired,TResult Function( String peerId)?  peerDisconnected,TResult Function()?  roomCleared,TResult Function( String address)?  listening,TResult Function( String fromPeer,  String text,  PlatformInt64 timestamp,  String messageId,  String replyToMid,  LinkPreviewRef? linkPreview,  String? signature,  String? publicKey,  String? albumId,  bool isOwn,  bool duplicate)?  messageReceived,TResult Function( String serverId,  String channelId,  String fromPeer,  String text,  PlatformInt64 timestamp,  String messageId,  String replyToMid,  LinkPreviewRef? linkPreview,  String? signature,  String? publicKey,  String? albumId,  bool replyToOwn,  bool duplicate,  bool isOwn)?  channelMessageReceived,TResult Function( String toPeer,  String messageId,  PlatformInt64 timestamp,  String? signature,  String? publicKey)?  messageSent,TResult Function( String serverId,  String channelId,  String messageId,  PlatformInt64 timestamp,  String? signature,  String? publicKey)?  channelMessageSent,TResult Function( String toPeer,  String error)?  messageSendFailed,TResult Function( String peerId)?  sessionEstablished,TResult Function( String message)?  error,TResult Function( String serverId,  String name)?  serverCreated,TResult Function( String serverId)?  serverUpdated,TResult Function( List<String> hashes)?  emoteAssetsReceived,TResult Function()?  personalEmotesUpdated,TResult Function( String serverId,  String channelId,  String name,  String channelType)?  channelAdded,TResult Function( String serverId,  String channelId)?  channelRemoved,TResult Function( String serverId,  String channelId,  String newName)?  channelRenamed,TResult Function( String serverId)?  serverDeleted,TResult Function( String serverId,  String peerId)?  memberJoined,TResult Function( String serverId,  String peerId)?  memberLeft,TResult Function( String serverId,  int opsApplied)?  syncCompleted,TResult Function( String serverId,  String name)?  serverJoined,TResult Function( String serverId,  String reason)?  serverJoinFailed,TResult Function( String serverId)?  serverJoinParked,TResult Function( String serverId,  String state,  String reason)?  pendingJoinUpdated,TResult Function( String serverId,  String peerId)?  messageSyncStarted,TResult Function( String serverId,  int newMessageCount)?  messageSyncCompleted,TResult Function( String serverId,  String error)?  messageSyncFailed,TResult Function( String serverId,  String channelId,  int receivedCount,  int totalCount)?  messageSyncProgress,TResult Function( String serverId,  String peerId,  String newRole)?  roleChanged,TResult Function( String peerId,  int newMessageCount)?  dmSyncCompleted,TResult Function( String peerId)?  profileUpdated,TResult Function( String masterPeerId)?  deviceListUpdated,TResult Function( List<ReadMarkerEntry> markers)?  readMarkersReceived,TResult Function( String peerId,  String kind,  String detail,  PlatformInt64 createdAt)?  securityAlert,TResult Function()?  selfRevoked,TResult Function( String scope)?  destroyReceived,TResult Function( String masterPeerId,  PlatformInt64 issuedAtMs)?  identityDestroyedByFriend,TResult Function( String serverId,  String channelId,  String messageId,  String newText,  PlatformInt64 editedAt,  String? signature,  String? publicKey)?  channelMessageEdited,TResult Function( String peerId,  String messageId,  String newText,  PlatformInt64 editedAt,  String? signature,  String? publicKey)?  dmMessageEdited,TResult Function( String serverId,  String channelId,  String messageId,  LinkPreviewRef? preview)?  channelLinkPreviewUpdated,TResult Function( String peerId,  String messageId,  LinkPreviewRef? preview)?  dmLinkPreviewUpdated,TResult Function( String serverId,  String channelId,  String messageId,  PlatformInt64 deletedAt)?  channelMessageDeleted,TResult Function( String peerId,  String messageId,  PlatformInt64 deletedAt)?  dmMessageDeleted,TResult Function( String serverId,  String channelId,  String messageId,  String emoji,  String reactor,  PlatformInt64 addedAt)?  channelReactionAdded,TResult Function( String peerId,  String messageId,  String emoji,  String reactor,  PlatformInt64 addedAt)?  dmReactionAdded,TResult Function( String serverId,  String channelId,  String messageId,  String emoji,  String reactor,  PlatformInt64 removedAt)?  channelReactionRemoved,TResult Function( String peerId,  String messageId,  String emoji,  String reactor,  PlatformInt64 removedAt)?  dmReactionRemoved,TResult Function( String peerId)?  friendRequestReceived,TResult Function( String peerId)?  friendRequestAccepted,TResult Function( String peerId)?  friendRequestRejected,TResult Function( String peerId)?  friendRemoved,TResult Function( int count)?  friendsBackfilled,TResult Function( String nickname)?  nicknameClaimed,TResult Function()?  nicknameReleased,TResult Function( String error)?  nicknameClaimFailed,TResult Function( String nickname,  String error)?  nicknameResolveFailed,TResult Function()?  relayDisconnected,TResult Function()?  relayConnected,TResult Function( bool reconnecting)?  relayConnecting,TResult Function( String serverId,  String channelId,  String fromPeer,  String messageId,  bool hasEveryone,  List<String> mentionedNames,  bool isReplyToOwn)?  channelNotificationHint,TResult Function( String peerId,  String serverId,  String channelId)?  typingStarted,TResult Function( String peerId,  String status)?  peerStatusChanged,TResult Function( String serverId,  String channelId,  String messageId)?  messagePinned,TResult Function( String serverId,  String channelId,  String messageId)?  messageUnpinned,TResult Function( String fileId,  String fileName,  BigInt sizeBytes,  bool isImage,  int? width,  int? height,  String messageId,  String senderId,  String serverId,  String channelId,  VideoThumbRef? videoThumb,  String? shareRootHash,  String? shareKeyHex,  String? thumbB64)?  fileHeaderReceived,TResult Function( String fileId,  int chunksReceived,  int totalChunks)?  fileProgress,TResult Function( String fileId,  String diskPath)?  fileCompleted,TResult Function( String fileId,  String error)?  fileFailed,TResult Function( String fileId,  String state,  String peerId)?  fileAvailability,TResult Function( String username,  String password,  BigInt ttl,  List<String> uris)?  turnCredentials,TResult Function( String code)?  linkCodeClaimed,TResult Function( String error,  String code)?  linkCodeError,TResult Function( String peerId,  int theirMsgCount,  int theirFriendCount,  bool theirHasProfile)?  siblingLinkAvailable,TResult Function( String linkId,  BigInt bytesReceived,  BigInt totalBytes)?  linkProgress,TResult Function( String linkId,  int msgCount,  int friendCount,  int serverCount)?  linkComplete,TResult Function( String linkId,  String error)?  linkFailed,TResult Function( BigInt bytes)?  linkPushComplete,TResult Function( String serverId,  String contentId,  int shardIndex,  String fromPeer)?  shardStored,TResult Function( String serverId,  String contentId,  int shardIndex,  bool success,  String error)?  shardStoreAckReceived,TResult Function( String serverId,  String contentId,  int shardIndex,  String targetPeer,  String error)?  shardStoreFailed,TResult Function( String serverId,  String contentId)?  shardDeleted,TResult Function( String serverId,  String contentId,  int shardIndex,  String fromPeer)?  shardReceived,TResult Function( String serverId,  String contentId,  int shardIndex,  String error)?  shardRequestFailed,TResult Function( String serverId,  String contentId,  String phase,  double progress)?  vaultUploadProgress,TResult Function( String serverId,  String contentId,  String channelId)?  vaultUploadComplete,TResult Function( String serverId,  String contentId,  String error)?  vaultUploadFailed,TResult Function( String serverId,  String contentId,  String phase,  double progress)?  vaultDownloadProgress,TResult Function( String serverId,  String contentId,  String diskPath)?  vaultDownloadComplete,TResult Function( String serverId,  String contentId,  String error)?  vaultDownloadFailed,TResult Function( String serverId,  int shardsToMove)?  rebalanceStarted,TResult Function( String serverId,  int moved,  int total)?  rebalanceProgress,TResult Function( String serverId)?  rebalanceCompleted,TResult Function( String serverId,  String contentId,  BigInt online,  BigInt needed)?  vaultUploadReplicationFallback,TResult Function( String peerId)?  keyExchangeStarted,TResult Function( String peerId,  String stage)?  keyExchangeProgress,TResult Function( String peerId,  String signalType,  String payload,  String connId)?  webRtcSignal,TResult Function( String peerId,  String transferId,  String filePath,  BigInt totalSize,  String kind,  int shardIndex,  int chunkIndex)?  webRtcSendFile,TResult Function( String peerId,  String signalType,  String payload)?  callSignal,TResult Function( String serverId,  String channelId,  String peerId,  bool isSelf)?  voiceChannelJoined,TResult Function( String serverId,  String channelId,  String peerId,  bool isSelf)?  voiceChannelLeft,TResult Function( String serverId,  String channelId,  String peerId,  String signalType,  String payload)?  voiceChannelSignal,TResult Function( String fromPeer,  String signalType,  String payload)?  forwarderSignal,TResult Function( String peerId,  bool online)?  mediaForwarderInfo,TResult Function( String peerId)?  gossipConnect,TResult Function( String peerId)?  gossipDisconnect,TResult Function( String broadcastId,  int ttl,  String originPeerId,  String filePath,  BigInt totalSize,  String kind,  int shardIndex,  String excludePeerId,  String serverId,  String channelId)?  gossipRelayFile,TResult Function( List<String> targets,  Uint8List payload)?  gossipRelayOp,TResult Function( String serverId,  String channelId,  String mode,  List<String> gossipNeighbors)?  voiceChannelModeChanged,TResult Function( String serverId,  BigInt epoch,  Uint8List sframeKey,  String? channelId)?  mlsEpochChanged,TResult Function( String confId,  String peerId,  String displayName,  String avatarHash)?  conferenceJoinRequestReceived,TResult Function( String confId,  String reason)?  conferenceJoinDenied,TResult Function( String confId,  String hostPeerId,  String hostName,  String hostAvatarHash)?  conferenceLobbyInfo,TResult Function( String confId)?  conferenceAdmitted,TResult Function( String confId,  String senderPeerId,  String text,  PlatformInt64 timestamp)?  conferenceChatMessage,TResult Function( String confId,  String byPeerId)?  conferenceEnded,TResult Function( String confId,  String byPeerId)?  conferenceKicked,TResult Function( String serverId,  String inviteLink)?  recoveryPoolCreated,TResult Function( String serverId)?  recoveryPoolJoined,TResult Function( String serverId,  String reason)?  recoveryPoolJoinFailed,TResult Function( String serverId,  String peerId)?  recoveryPoolMemberJoined,TResult Function( String serverId,  String peerId)?  recoveryPoolMemberLeft,TResult Function( String serverId,  int totalFiles,  int reconstructable,  int partial,  int noShards,  double progressPct)?  recoveryPoolStatus,TResult Function( String serverId,  String contentId,  int shardIndex)?  recoveryPoolShardTransferred,TResult Function( String serverId,  String contentId,  String diskPath)?  recoveryPoolFileRecovered,TResult Function( String serverId)?  recoveryPoolStopped,TResult Function( String rootHash,  String fileName,  BigInt totalSize,  int chunkCount)?  shareManifestReady,TResult Function( String rootHash,  int chunksHave,  int chunksTotal,  int seeders,  int leechers,  BigInt bytesPerSec)?  shareProgress,TResult Function( String rootHash,  String diskPath)?  shareCompleted,TResult Function( String rootHash,  String error)?  shareFailed,TResult Function( String rootHash,  bool seeding,  int seeders,  int leechers,  BigInt bytesUploaded)?  shareSeedingChanged,TResult Function( String rootHash,  String link,  String fileName,  BigInt totalSize)?  shareCreated,TResult Function( String rootHash,  String keyHex,  String fileName,  BigInt totalSize)?  shareCreatedHidden,TResult Function( List<ShareEntry> entries)?  shareList,TResult Function( String peerId,  bool hidden)?  shareNeedWebRtc,TResult Function( String reason)?  licenseError,TResult Function( String serverId,  String reason)?  twitchJoinRejected,TResult Function( int joined,  int limit)?  roomBudgetUpdate,TResult Function( String room)?  roomCapHit,TResult Function( String serverId,  String serverName,  List<PublicChannelEntryFfi> channels,  Uint8List? serverAvatar,  Uint8List? serverBannerThumb)?  publicChannelListReceived,TResult Function( String serverId,  String channelId,  List<GuestSyncMessageFfi> messages,  bool hasMore,  List<SyncSenderProfileFfi> senderProfiles)?  publicChannelSyncReceived,TResult Function( String serverId,  String channelId,  bool isPublic,  String channelName,  String? category)?  publicChannelConfigChanged,required TResult orElse(),}) {final _that = this;
switch (_that) {
case NetworkEvent_PeerDiscovered() when peerDiscovered != null:
...
return messageReceived(_that.fromPeer,_that.text,_that.timestamp,_that.messageId,_that.replyToMid,_that.linkPreview,_that.signature,_that.publicKey,_that.albumId,_that.isOwn,_that.duplicate);case NetworkEvent_ChannelMessageReceived() when channelMessageReceived != null:
return channelMessageReceived(_that.serverId,_that.channelId,_that.fromPeer,_that.text,_that.timestamp,_that.messageId,_that.replyToMid,_that.linkPreview,_that.signature,_that.publicKey,_that.albumId,_that.replyToOwn,_that.duplicate,_that.isOwn);case NetworkEvent_MessageSent() when messageSent != null:
...
return serverUpdated(_that.serverId);case NetworkEvent_EmoteAssetsReceived() when emoteAssetsReceived != null:
return emoteAssetsReceived(_that.hashes);case NetworkEvent_PersonalEmotesUpdated() when personalEmotesUpdated != null:
return personalEmotesUpdated();case NetworkEvent_ChannelAdded() when channelAdded != null:
...
return serverJoinFailed(_that.serverId,_that.reason);case NetworkEvent_ServerJoinParked() when serverJoinParked != null:
return serverJoinParked(_that.serverId);case NetworkEvent_PendingJoinUpdated() when pendingJoinUpdated != null:
return pendingJoinUpdated(_that.serverId,_that.state,_that.reason);case NetworkEvent_MessageSyncStarted() when messageSyncStarted != null:
...
return profileUpdated(_that.peerId);case NetworkEvent_DeviceListUpdated() when deviceListUpdated != null:
return deviceListUpdated(_that.masterPeerId);case NetworkEvent_ReadMarkersReceived() when readMarkersReceived != null:
return readMarkersReceived(_that.markers);case NetworkEvent_SecurityAlert() when securityAlert != null:
return securityAlert(_that.peerId,_that.kind,_that.detail,_that.createdAt);case NetworkEvent_SelfRevoked() when selfRevoked != null:
return selfRevoked();case NetworkEvent_DestroyReceived() when destroyReceived != null:
return destroyReceived(_that.scope);case NetworkEvent_IdentityDestroyedByFriend() when identityDestroyedByFriend != null:
return identityDestroyedByFriend(_that.masterPeerId,_that.issuedAtMs);case NetworkEvent_ChannelMessageEdited() when channelMessageEdited != null:
...
return dmMessageEdited(_that.peerId,_that.messageId,_that.newText,_that.editedAt,_that.signature,_that.publicKey);case NetworkEvent_ChannelLinkPreviewUpdated() when channelLinkPreviewUpdated != null:
return channelLinkPreviewUpdated(_that.serverId,_that.channelId,_that.messageId,_that.preview);case NetworkEvent_DmLinkPreviewUpdated() when dmLinkPreviewUpdated != null:
return dmLinkPreviewUpdated(_that.peerId,_that.messageId,_that.preview);case NetworkEvent_ChannelMessageDeleted() when channelMessageDeleted != null:
...
return friendRemoved(_that.peerId);case NetworkEvent_FriendsBackfilled() when friendsBackfilled != null:
return friendsBackfilled(_that.count);case NetworkEvent_NicknameClaimed() when nicknameClaimed != null:
return nicknameClaimed(_that.nickname);case NetworkEvent_NicknameReleased() when nicknameReleased != null:
return nicknameReleased();case NetworkEvent_NicknameClaimFailed() when nicknameClaimFailed != null:
return nicknameClaimFailed(_that.error);case NetworkEvent_NicknameResolveFailed() when nicknameResolveFailed != null:
return nicknameResolveFailed(_that.nickname,_that.error);case NetworkEvent_RelayDisconnected() when relayDisconnected != null:
return relayDisconnected();case NetworkEvent_RelayConnected() when relayConnected != null:
return relayConnected();case NetworkEvent_RelayConnecting() when relayConnecting != null:
return relayConnecting(_that.reconnecting);case NetworkEvent_ChannelNotificationHint() when channelNotificationHint != null:
return channelNotificationHint(_that.serverId,_that.channelId,_that.fromPeer,_that.messageId,_that.hasEveryone,_that.mentionedNames,_that.isReplyToOwn);case NetworkEvent_TypingStarted() when typingStarted != null:
...
return fileHeaderReceived(_that.fileId,_that.fileName,_that.sizeBytes,_that.isImage,_that.width,_that.height,_that.messageId,_that.senderId,_that.serverId,_that.channelId,_that.videoThumb,_that.shareRootHash,_that.shareKeyHex,_that.thumbB64);case NetworkEvent_FileProgress() when fileProgress != null:
...
return fileFailed(_that.fileId,_that.error);case NetworkEvent_FileAvailability() when fileAvailability != null:
return fileAvailability(_that.fileId,_that.state,_that.peerId);case NetworkEvent_TurnCredentials() when turnCredentials != null:
return turnCredentials(_that.username,_that.password,_that.ttl,_that.uris);case NetworkEvent_LinkCodeClaimed() when linkCodeClaimed != null:
return linkCodeClaimed(_that.code);case NetworkEvent_LinkCodeError() when linkCodeError != null:
return linkCodeError(_that.error,_that.code);case NetworkEvent_SiblingLinkAvailable() when siblingLinkAvailable != null:
return siblingLinkAvailable(_that.peerId,_that.theirMsgCount,_that.theirFriendCount,_that.theirHasProfile);case NetworkEvent_LinkProgress() when linkProgress != null:
return linkProgress(_that.linkId,_that.bytesReceived,_that.totalBytes);case NetworkEvent_LinkComplete() when linkComplete != null:
return linkComplete(_that.linkId,_that.msgCount,_that.friendCount,_that.serverCount);case NetworkEvent_LinkFailed() when linkFailed != null:
return linkFailed(_that.linkId,_that.error);case NetworkEvent_LinkPushComplete() when linkPushComplete != null:
return linkPushComplete(_that.bytes);case NetworkEvent_ShardStored() when shardStored != null:
...
return voiceChannelJoined(_that.serverId,_that.channelId,_that.peerId,_that.isSelf);case NetworkEvent_VoiceChannelLeft() when voiceChannelLeft != null:
return voiceChannelLeft(_that.serverId,_that.channelId,_that.peerId,_that.isSelf);case NetworkEvent_VoiceChannelSignal() when voiceChannelSignal != null:
return voiceChannelSignal(_that.serverId,_that.channelId,_that.peerId,_that.signalType,_that.payload);case NetworkEvent_ForwarderSignal() when forwarderSignal != null:
return forwarderSignal(_that.fromPeer,_that.signalType,_that.payload);case NetworkEvent_MediaForwarderInfo() when mediaForwarderInfo != null:
return mediaForwarderInfo(_that.peerId,_that.online);case NetworkEvent_GossipConnect() when gossipConnect != null:
...
return gossipRelayFile(_that.broadcastId,_that.ttl,_that.originPeerId,_that.filePath,_that.totalSize,_that.kind,_that.shardIndex,_that.excludePeerId,_that.serverId,_that.channelId);case NetworkEvent_GossipRelayOp() when gossipRelayOp != null:
return gossipRelayOp(_that.targets,_that.payload);case NetworkEvent_VoiceChannelModeChanged() when voiceChannelModeChanged != null:
...
return mlsEpochChanged(_that.serverId,_that.epoch,_that.sframeKey,_that.channelId);case NetworkEvent_ConferenceJoinRequestReceived() when conferenceJoinRequestReceived != null:
return conferenceJoinRequestReceived(_that.confId,_that.peerId,_that.displayName,_that.avatarHash);case NetworkEvent_ConferenceJoinDenied() when conferenceJoinDenied != null:
return conferenceJoinDenied(_that.confId,_that.reason);case NetworkEvent_ConferenceLobbyInfo() when conferenceLobbyInfo != null:
return conferenceLobbyInfo(_that.confId,_that.hostPeerId,_that.hostName,_that.hostAvatarHash);case NetworkEvent_ConferenceAdmitted() when conferenceAdmitted != null:
return conferenceAdmitted(_that.confId);case NetworkEvent_ConferenceChatMessage() when conferenceChatMessage != null:
return conferenceChatMessage(_that.confId,_that.senderPeerId,_that.text,_that.timestamp);case NetworkEvent_ConferenceEnded() when conferenceEnded != null:
return conferenceEnded(_that.confId,_that.byPeerId);case NetworkEvent_ConferenceKicked() when conferenceKicked != null:
return conferenceKicked(_that.confId,_that.byPeerId);case NetworkEvent_RecoveryPoolCreated() when recoveryPoolCreated != null:
...
return publicChannelListReceived(_that.serverId,_that.serverName,_that.channels,_that.serverAvatar,_that.serverBannerThumb);case NetworkEvent_PublicChannelSyncReceived() when publicChannelSyncReceived != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( DiscoveredPeer peer)  peerDiscovered,required TResult Function( String peerId)  peerExpired,required TResult Function( String peerId)  peerDisconnected,required TResult Function()  roomCleared,required TResult Function( String address)  listening,required TResult Function( String fromPeer,  String text,  PlatformInt64 timestamp,  String messageId,  String replyToMid,  LinkPreviewRef? linkPreview,  String? signature,  String? publicKey,  String? albumId,  bool isOwn,  bool duplicate)  messageReceived,required TResult Function( String serverId,  String channelId,  String fromPeer,  String text,  PlatformInt64 timestamp,  String messageId,  String replyToMid,  LinkPreviewRef? linkPreview,  String? signature,  String? publicKey,  String? albumId,  bool replyToOwn,  bool duplicate,  bool isOwn)  channelMessageReceived,required TResult Function( String toPeer,  String messageId,  PlatformInt64 timestamp,  String? signature,  String? publicKey)  messageSent,required TResult Function( String serverId,  String channelId,  String messageId,  PlatformInt64 timestamp,  String? signature,  String? publicKey)  channelMessageSent,required TResult Function( String toPeer,  String error)  messageSendFailed,required TResult Function( String peerId)  sessionEstablished,required TResult Function( String message)  error,required TResult Function( String serverId,  String name)  serverCreated,required TResult Function( String serverId)  serverUpdated,required TResult Function( List<String> hashes)  emoteAssetsReceived,required TResult Function()  personalEmotesUpdated,required TResult Function( String serverId,  String channelId,  String name,  String channelType)  channelAdded,required TResult Function( String serverId,  String channelId)  channelRemoved,required TResult Function( String serverId,  String channelId,  String newName)  channelRenamed,required TResult Function( String serverId)  serverDeleted,required TResult Function( String serverId,  String peerId)  memberJoined,required TResult Function( String serverId,  String peerId)  memberLeft,required TResult Function( String serverId,  int opsApplied)  syncCompleted,required TResult Function( String serverId,  String name)  serverJoined,required TResult Function( String serverId,  String reason)  serverJoinFailed,required TResult Function( String serverId)  serverJoinParked,required TResult Function( String serverId,  String state,  String reason)  pendingJoinUpdated,required TResult Function( String serverId,  String peerId)  messageSyncStarted,required TResult Function( String serverId,  int newMessageCount)  messageSyncCompleted,required TResult Function( String serverId,  String error)  messageSyncFailed,required TResult Function( String serverId,  String channelId,  int receivedCount,  int totalCount)  messageSyncProgress,required TResult Function( String serverId,  String peerId,  String newRole)  roleChanged,required TResult Function( String peerId,  int newMessageCount)  dmSyncCompleted,required TResult Function( String peerId)  profileUpdated,required TResult Function( String masterPeerId)  deviceListUpdated,required TResult Function( List<ReadMarkerEntry> markers)  readMarkersReceived,required TResult Function( String peerId,  String kind,  String detail,  PlatformInt64 createdAt)  securityAlert,required TResult Function()  selfRevoked,required TResult Function( String scope)  destroyReceived,required TResult Function( String masterPeerId,  PlatformInt64 issuedAtMs)  identityDestroyedByFriend,required TResult Function( String serverId,  String channelId,  String messageId,  String newText,  PlatformInt64 editedAt,  String? signature,  String? publicKey)  channelMessageEdited,required TResult Function( String peerId,  String messageId,  String newText,  PlatformInt64 editedAt,  String? signature,  String? publicKey)  dmMessageEdited,required TResult Function( String serverId,  String channelId,  String messageId,  LinkPreviewRef? preview)  channelLinkPreviewUpdated,required TResult Function( String peerId,  String messageId,  LinkPreviewRef? preview)  dmLinkPreviewUpdated,required TResult Function( String serverId,  String channelId,  String messageId,  PlatformInt64 deletedAt)  channelMessageDeleted,required TResult Function( String peerId,  String messageId,  PlatformInt64 deletedAt)  dmMessageDeleted,required TResult Function( String serverId,  String channelId,  String messageId,  String emoji,  String reactor,  PlatformInt64 addedAt)  channelReactionAdded,required TResult Function( String peerId,  String messageId,  String emoji,  String reactor,  PlatformInt64 addedAt)  dmReactionAdded,required TResult Function( String serverId,  String channelId,  String messageId,  String emoji,  String reactor,  PlatformInt64 removedAt)  channelReactionRemoved,required TResult Function( String peerId,  String messageId,  String emoji,  String reactor,  PlatformInt64 removedAt)  dmReactionRemoved,required TResult Function( String peerId)  friendRequestReceived,required TResult Function( String peerId)  friendRequestAccepted,required TResult Function( String peerId)  friendRequestRejected,required TResult Function( String peerId)  friendRemoved,required TResult Function( int count)  friendsBackfilled,required TResult Function( String nickname)  nicknameClaimed,required TResult Function()  nicknameReleased,required TResult Function( String error)  nicknameClaimFailed,required TResult Function( String nickname,  String error)  nicknameResolveFailed,required TResult Function()  relayDisconnected,required TResult Function()  relayConnected,required TResult Function( bool reconnecting)  relayConnecting,required TResult Function( String serverId,  String channelId,  String fromPeer,  String messageId,  bool hasEveryone,  List<String> mentionedNames,  bool isReplyToOwn)  channelNotificationHint,required TResult Function( String peerId,  String serverId,  String channelId)  typingStarted,required TResult Function( String peerId,  String status)  peerStatusChanged,required TResult Function( String serverId,  String channelId,  String messageId)  messagePinned,required TResult Function( String serverId,  String channelId,  String messageId)  messageUnpinned,required TResult Function( String fileId,  String fileName,  BigInt sizeBytes,  bool isImage,  int? width,  int? height,  String messageId,  String senderId,  String serverId,  String channelId,  VideoThumbRef? videoThumb,  String? shareRootHash,  String? shareKeyHex,  String? thumbB64)  fileHeaderReceived,required TResult Function( String fileId,  int chunksReceived,  int totalChunks)  fileProgress,required TResult Function( String fileId,  String diskPath)  fileCompleted,required TResult Function( String fileId,  String error)  fileFailed,required TResult Function( String fileId,  String state,  String peerId)  fileAvailability,required TResult Function( String username,  String password,  BigInt ttl,  List<String> uris)  turnCredentials,required TResult Function( String code)  linkCodeClaimed,required TResult Function( String error,  String code)  linkCodeError,required TResult Function( String peerId,  int theirMsgCount,  int theirFriendCount,  bool theirHasProfile)  siblingLinkAvailable,required TResult Function( String linkId,  BigInt bytesReceived,  BigInt totalBytes)  linkProgress,required TResult Function( String linkId,  int msgCount,  int friendCount,  int serverCount)  linkComplete,required TResult Function( String linkId,  String error)  linkFailed,required TResult Function( BigInt bytes)  linkPushComplete,required TResult Function( String serverId,  String contentId,  int shardIndex,  String fromPeer)  shardStored,required TResult Function( String serverId,  String contentId,  int shardIndex,  bool success,  String error)  shardStoreAckReceived,required TResult Function( String serverId,  String contentId,  int shardIndex,  String targetPeer,  String error)  shardStoreFailed,required TResult Function( String serverId,  String contentId)  shardDeleted,required TResult Function( String serverId,  String contentId,  int shardIndex,  String fromPeer)  shardReceived,required TResult Function( String serverId,  String contentId,  int shardIndex,  String error)  shardRequestFailed,required TResult Function( String serverId,  String contentId,  String phase,  double progress)  vaultUploadProgress,required TResult Function( String serverId,  String contentId,  String channelId)  vaultUploadComplete,required TResult Function( String serverId,  String contentId,  String error)  vaultUploadFailed,required TResult Function( String serverId,  String contentId,  String phase,  double progress)  vaultDownloadProgress,required TResult Function( String serverId,  String contentId,  String diskPath)  vaultDownloadComplete,required TResult Function( String serverId,  String contentId,  String error)  vaultDownloadFailed,required TResult Function( String serverId,  int shardsToMove)  rebalanceStarted,required TResult Function( String serverId,  int moved,  int total)  rebalanceProgress,required TResult Function( String serverId)  rebalanceCompleted,required TResult Function( String serverId,  String contentId,  BigInt online,  BigInt needed)  vaultUploadReplicationFallback,required TResult Function( String peerId)  keyExchangeStarted,required TResult Function( String peerId,  String stage)  keyExchangeProgress,required TResult Function( String peerId,  String signalType,  String payload,  String connId)  webRtcSignal,required TResult Function( String peerId,  String transferId,  String filePath,  BigInt totalSize,  String kind,  int shardIndex,  int chunkIndex)  webRtcSendFile,required TResult Function( String peerId,  String signalType,  String payload)  callSignal,required TResult Function( String serverId,  String channelId,  String peerId,  bool isSelf)  voiceChannelJoined,required TResult Function( String serverId,  String channelId,  String peerId,  bool isSelf)  voiceChannelLeft,required TResult Function( String serverId,  String channelId,  String peerId,  String signalType,  String payload)  voiceChannelSignal,required TResult Function( String fromPeer,  String signalType,  String payload)  forwarderSignal,required TResult Function( String peerId,  bool online)  mediaForwarderInfo,required TResult Function( String peerId)  gossipConnect,required TResult Function( String peerId)  gossipDisconnect,required TResult Function( String broadcastId,  int ttl,  String originPeerId,  String filePath,  BigInt totalSize,  String kind,  int shardIndex,  String excludePeerId,  String serverId,  String channelId)  gossipRelayFile,required TResult Function( List<String> targets,  Uint8List payload)  gossipRelayOp,required TResult Function( String serverId,  String channelId,  String mode,  List<String> gossipNeighbors)  voiceChannelModeChanged,required TResult Function( String serverId,  BigInt epoch,  Uint8List sframeKey,  String? channelId)  mlsEpochChanged,required TResult Function( String confId,  String peerId,  String displayName,  String avatarHash)  conferenceJoinRequestReceived,required TResult Function( String confId,  String reason)  conferenceJoinDenied,required TResult Function( String confId,  String hostPeerId,  String hostName,  String hostAvatarHash)  conferenceLobbyInfo,required TResult Function( String confId)  conferenceAdmitted,required TResult Function( String confId,  String senderPeerId,  String text,  PlatformInt64 timestamp)  conferenceChatMessage,required TResult Function( String confId,  String byPeerId)  conferenceEnded,required TResult Function( String confId,  String byPeerId)  conferenceKicked,required TResult Function( String serverId,  String inviteLink)  recoveryPoolCreated,required TResult Function( String serverId)  recoveryPoolJoined,required TResult Function( String serverId,  String reason)  recoveryPoolJoinFailed,required TResult Function( String serverId,  String peerId)  recoveryPoolMemberJoined,required TResult Function( String serverId,  String peerId)  recoveryPoolMemberLeft,required TResult Function( String serverId,  int totalFiles,  int reconstructable,  int partial,  int noShards,  double progressPct)  recoveryPoolStatus,required TResult Function( String serverId,  String contentId,  int shardIndex)  recoveryPoolShardTransferred,required TResult Function( String serverId,  String contentId,  String diskPath)  recoveryPoolFileRecovered,required TResult Function( String serverId)  recoveryPoolStopped,required TResult Function( String rootHash,  String fileName,  BigInt totalSize,  int chunkCount)  shareManifestReady,required TResult Function( String rootHash,  int chunksHave,  int chunksTotal,  int seeders,  int leechers,  BigInt bytesPerSec)  shareProgress,required TResult Function( String rootHash,  String diskPath)  shareCompleted,required TResult Function( String rootHash,  String error)  shareFailed,required TResult Function( String rootHash,  bool seeding,  int seeders,  int leechers,  BigInt bytesUploaded)  shareSeedingChanged,required TResult Function( String rootHash,  String link,  String fileName,  BigInt totalSize)  shareCreated,required TResult Function( String rootHash,  String keyHex,  String fileName,  BigInt totalSize)  shareCreatedHidden,required TResult Function( List<ShareEntry> entries)  shareList,required TResult Function( String peerId,  bool hidden)  shareNeedWebRtc,required TResult Function( String reason)  licenseError,required TResult Function( String serverId,  String reason)  twitchJoinRejected,required TResult Function( int joined,  int limit)  roomBudgetUpdate,required TResult Function( String room)  roomCapHit,required TResult Function( String serverId,  String serverName,  List<PublicChannelEntryFfi> channels,  Uint8List? serverAvatar,  Uint8List? serverBannerThumb)  publicChannelListReceived,required TResult Function( String serverId,  String channelId,  List<GuestSyncMessageFfi> messages,  bool hasMore,  List<SyncSenderProfileFfi> senderProfiles)  publicChannelSyncReceived,required TResult Function( String serverId,  String channelId,  bool isPublic,  String channelName,  String? category)  publicChannelConfigChanged,}) {final _that = this;
switch (_that) {
case NetworkEvent_PeerDiscovered():
...
return messageReceived(_that.fromPeer,_that.text,_that.timestamp,_that.messageId,_that.replyToMid,_that.linkPreview,_that.signature,_that.publicKey,_that.albumId,_that.isOwn,_that.duplicate);case NetworkEvent_ChannelMessageReceived():
return channelMessageReceived(_that.serverId,_that.channelId,_that.fromPeer,_that.text,_that.timestamp,_that.messageId,_that.replyToMid,_that.linkPreview,_that.signature,_that.publicKey,_that.albumId,_that.replyToOwn,_that.duplicate,_that.isOwn);case NetworkEvent_MessageSent():
...
return serverUpdated(_that.serverId);case NetworkEvent_EmoteAssetsReceived():
return emoteAssetsReceived(_that.hashes);case NetworkEvent_PersonalEmotesUpdated():
return personalEmotesUpdated();case NetworkEvent_ChannelAdded():
...
return serverJoinFailed(_that.serverId,_that.reason);case NetworkEvent_ServerJoinParked():
return serverJoinParked(_that.serverId);case NetworkEvent_PendingJoinUpdated():
return pendingJoinUpdated(_that.serverId,_that.state,_that.reason);case NetworkEvent_MessageSyncStarted():
...
return profileUpdated(_that.peerId);case NetworkEvent_DeviceListUpdated():
return deviceListUpdated(_that.masterPeerId);case NetworkEvent_ReadMarkersReceived():
return readMarkersReceived(_that.markers);case NetworkEvent_SecurityAlert():
return securityAlert(_that.peerId,_that.kind,_that.detail,_that.createdAt);case NetworkEvent_SelfRevoked():
return selfRevoked();case NetworkEvent_DestroyReceived():
return destroyReceived(_that.scope);case NetworkEvent_IdentityDestroyedByFriend():
return identityDestroyedByFriend(_that.masterPeerId,_that.issuedAtMs);case NetworkEvent_ChannelMessageEdited():
...
return dmMessageEdited(_that.peerId,_that.messageId,_that.newText,_that.editedAt,_that.signature,_that.publicKey);case NetworkEvent_ChannelLinkPreviewUpdated():
return channelLinkPreviewUpdated(_that.serverId,_that.channelId,_that.messageId,_that.preview);case NetworkEvent_DmLinkPreviewUpdated():
return dmLinkPreviewUpdated(_that.peerId,_that.messageId,_that.preview);case NetworkEvent_ChannelMessageDeleted():
...
return friendRemoved(_that.peerId);case NetworkEvent_FriendsBackfilled():
return friendsBackfilled(_that.count);case NetworkEvent_NicknameClaimed():
return nicknameClaimed(_that.nickname);case NetworkEvent_NicknameReleased():
return nicknameReleased();case NetworkEvent_NicknameClaimFailed():
return nicknameClaimFailed(_that.error);case NetworkEvent_NicknameResolveFailed():
return nicknameResolveFailed(_that.nickname,_that.error);case NetworkEvent_RelayDisconnected():
return relayDisconnected();case NetworkEvent_RelayConnected():
return relayConnected();case NetworkEvent_RelayConnecting():
return relayConnecting(_that.reconnecting);case NetworkEvent_ChannelNotificationHint():
return channelNotificationHint(_that.serverId,_that.channelId,_that.fromPeer,_that.messageId,_that.hasEveryone,_that.mentionedNames,_that.isReplyToOwn);case NetworkEvent_TypingStarted():
...
return fileHeaderReceived(_that.fileId,_that.fileName,_that.sizeBytes,_that.isImage,_that.width,_that.height,_that.messageId,_that.senderId,_that.serverId,_that.channelId,_that.videoThumb,_that.shareRootHash,_that.shareKeyHex,_that.thumbB64);case NetworkEvent_FileProgress():
...
return fileFailed(_that.fileId,_that.error);case NetworkEvent_FileAvailability():
return fileAvailability(_that.fileId,_that.state,_that.peerId);case NetworkEvent_TurnCredentials():
return turnCredentials(_that.username,_that.password,_that.ttl,_that.uris);case NetworkEvent_LinkCodeClaimed():
return linkCodeClaimed(_that.code);case NetworkEvent_LinkCodeError():
return linkCodeError(_that.error,_that.code);case NetworkEvent_SiblingLinkAvailable():
return siblingLinkAvailable(_that.peerId,_that.theirMsgCount,_that.theirFriendCount,_that.theirHasProfile);case NetworkEvent_LinkProgress():
return linkProgress(_that.linkId,_that.bytesReceived,_that.totalBytes);case NetworkEvent_LinkComplete():
return linkComplete(_that.linkId,_that.msgCount,_that.friendCount,_that.serverCount);case NetworkEvent_LinkFailed():
return linkFailed(_that.linkId,_that.error);case NetworkEvent_LinkPushComplete():
return linkPushComplete(_that.bytes);case NetworkEvent_ShardStored():
...
return voiceChannelJoined(_that.serverId,_that.channelId,_that.peerId,_that.isSelf);case NetworkEvent_VoiceChannelLeft():
return voiceChannelLeft(_that.serverId,_that.channelId,_that.peerId,_that.isSelf);case NetworkEvent_VoiceChannelSignal():
return voiceChannelSignal(_that.serverId,_that.channelId,_that.peerId,_that.signalType,_that.payload);case NetworkEvent_ForwarderSignal():
return forwarderSignal(_that.fromPeer,_that.signalType,_that.payload);case NetworkEvent_MediaForwarderInfo():
return mediaForwarderInfo(_that.peerId,_that.online);case NetworkEvent_GossipConnect():
...
return gossipRelayFile(_that.broadcastId,_that.ttl,_that.originPeerId,_that.filePath,_that.totalSize,_that.kind,_that.shardIndex,_that.excludePeerId,_that.serverId,_that.channelId);case NetworkEvent_GossipRelayOp():
return gossipRelayOp(_that.targets,_that.payload);case NetworkEvent_VoiceChannelModeChanged():
...
return mlsEpochChanged(_that.serverId,_that.epoch,_that.sframeKey,_that.channelId);case NetworkEvent_ConferenceJoinRequestReceived():
return conferenceJoinRequestReceived(_that.confId,_that.peerId,_that.displayName,_that.avatarHash);case NetworkEvent_ConferenceJoinDenied():
return conferenceJoinDenied(_that.confId,_that.reason);case NetworkEvent_ConferenceLobbyInfo():
return conferenceLobbyInfo(_that.confId,_that.hostPeerId,_that.hostName,_that.hostAvatarHash);case NetworkEvent_ConferenceAdmitted():
return conferenceAdmitted(_that.confId);case NetworkEvent_ConferenceChatMessage():
return conferenceChatMessage(_that.confId,_that.senderPeerId,_that.text,_that.timestamp);case NetworkEvent_ConferenceEnded():
return conferenceEnded(_that.confId,_that.byPeerId);case NetworkEvent_ConferenceKicked():
return conferenceKicked(_that.confId,_that.byPeerId);case NetworkEvent_RecoveryPoolCreated():
...
return publicChannelListReceived(_that.serverId,_that.serverName,_that.channels,_that.serverAvatar,_that.serverBannerThumb);case NetworkEvent_PublicChannelSyncReceived():
...
class NetworkEvent_MessageReceived extends NetworkEvent {
  const NetworkEvent_MessageReceived({required this.fromPeer, required this.text, required this.timestamp, required this.messageId, required this.replyToMid, this.linkPreview, this.signature, this.publicKey, this.albumId, required this.isOwn, required this.duplicate}): super._();
...
@override
int get hashCode => Object.hash(runtimeType,fromPeer,text,timestamp,messageId,replyToMid,linkPreview,signature,publicKey,albumId,isOwn,duplicate);

@override
String toString() {
  return 'NetworkEvent.messageReceived(fromPeer: $fromPeer, text: $text, timestamp: $timestamp, messageId: $messageId, replyToMid: $replyToMid, linkPreview: $linkPreview, signature: $signature, publicKey: $publicKey, albumId: $albumId, isOwn: $isOwn, duplicate: $duplicate)';
}
...
@useResult
$Res call({
 String fromPeer, String text, PlatformInt64 timestamp, String messageId, String replyToMid, LinkPreviewRef? linkPreview, String? signature, String? publicKey, String? albumId, bool isOwn, bool duplicate
});
...
/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? fromPeer = null,Object? text = null,Object? timestamp = null,Object? messageId = null,Object? replyToMid = null,Object? linkPreview = freezed,Object? signature = freezed,Object? publicKey = freezed,Object? albumId = freezed,Object? isOwn = null,Object? duplicate = null,}) {
...
as String?,isOwn: null == isOwn ? _self.isOwn : isOwn // ignore: cast_nullable_to_non_nullable
...
class NetworkEvent_ChannelMessageReceived extends NetworkEvent {
  const NetworkEvent_ChannelMessageReceived({required this.serverId, required this.channelId, required this.fromPeer, required this.text, required this.timestamp, required this.messageId, required this.replyToMid, this.linkPreview, this.signature, this.publicKey, this.albumId, required this.replyToOwn, required this.duplicate, required this.isOwn}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_ChannelMessageReceived&&(identical(other.serverId, serverId) || other.serverId == serverId)&&(identical(other.channelId, channelId) || other.channelId == channelId)&&(identical(other.fromPeer, fromPeer) || other.fromPeer == fromPeer)&&(identical(other.text, text) || other.text == text)&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp)&&(identical(other.messageId, messageId) || other.messageId == messageId)&&(identical(other.replyToMid, replyToMid) || other.replyToMid == replyToMid)&&(identical(other.linkPreview, linkPreview) || other.linkPreview == linkPreview)&&(identical(other.signature, signature) || other.signature == signature)&&(identical(other.publicKey, publicKey) || other.publicKey == publicKey)&&(identical(other.albumId, albumId) || other.albumId == albumId)&&(identical(other.replyToOwn, replyToOwn) || other.replyToOwn == replyToOwn)&&(identical(other.duplicate, duplicate) || other.duplicate == duplicate)&&(identical(other.isOwn, isOwn) || other.isOwn == isOwn));
}


@override
int get hashCode => Object.hash(runtimeType,serverId,channelId,fromPeer,text,timestamp,messageId,replyToMid,linkPreview,signature,publicKey,albumId,replyToOwn,duplicate,isOwn);

@override
String toString() {
  return 'NetworkEvent.channelMessageReceived(serverId: $serverId, channelId: $channelId, fromPeer: $fromPeer, text: $text, timestamp: $timestamp, messageId: $messageId, replyToMid: $replyToMid, linkPreview: $linkPreview, signature: $signature, publicKey: $publicKey, albumId: $albumId, replyToOwn: $replyToOwn, duplicate: $duplicate, isOwn: $isOwn)';
}
...
@useResult
$Res call({
 String serverId, String channelId, String fromPeer, String text, PlatformInt64 timestamp, String messageId, String replyToMid, LinkPreviewRef? linkPreview, String? signature, String? publicKey, String? albumId, bool replyToOwn, bool duplicate, bool isOwn
});
...
/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? serverId = null,Object? channelId = null,Object? fromPeer = null,Object? text = null,Object? timestamp = null,Object? messageId = null,Object? replyToMid = null,Object? linkPreview = freezed,Object? signature = freezed,Object? publicKey = freezed,Object? albumId = freezed,Object? replyToOwn = null,Object? duplicate = null,Object? isOwn = null,}) {
...
as String?,publicKey: freezed == publicKey ? _self.publicKey : publicKey // ignore: cast_nullable_to_non_nullable
as String?,albumId: freezed == albumId ? _self.albumId : albumId // ignore: cast_nullable_to_non_nullable
as String?,replyToOwn: null == replyToOwn ? _self.replyToOwn : replyToOwn // ignore: cast_nullable_to_non_nullable
as bool,duplicate: null == duplicate ? _self.duplicate : duplicate // ignore: cast_nullable_to_non_nullable
...
class NetworkEvent_EmoteAssetsReceived extends NetworkEvent {
  const NetworkEvent_EmoteAssetsReceived({required final  List<String> hashes}): _hashes = hashes,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_EmoteAssetsReceivedCopyWith<NetworkEvent_EmoteAssetsReceived> get copyWith => _$NetworkEvent_EmoteAssetsReceivedCopyWithImpl<NetworkEvent_EmoteAssetsReceived>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_EmoteAssetsReceived&&const DeepCollectionEquality().equals(other._hashes, _hashes));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_hashes));

@override
String toString() {
  return 'NetworkEvent.emoteAssetsReceived(hashes: $hashes)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_EmoteAssetsReceivedCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_EmoteAssetsReceivedCopyWith(NetworkEvent_EmoteAssetsReceived value, $Res Function(NetworkEvent_EmoteAssetsReceived) _then) = _$NetworkEvent_EmoteAssetsReceivedCopyWithImpl;
@useResult
$Res call({
 List<String> hashes
});
...
/// @nodoc
class _$NetworkEvent_EmoteAssetsReceivedCopyWithImpl<$Res>
    implements $NetworkEvent_EmoteAssetsReceivedCopyWith<$Res> {
  _$NetworkEvent_EmoteAssetsReceivedCopyWithImpl(this._self, this._then);

  final NetworkEvent_EmoteAssetsReceived _self;
  final $Res Function(NetworkEvent_EmoteAssetsReceived) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? hashes = null,}) {
  return _then(NetworkEvent_EmoteAssetsReceived(
hashes: null == hashes ? _self._hashes : hashes // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
...
class NetworkEvent_PersonalEmotesUpdated extends NetworkEvent {
  const NetworkEvent_PersonalEmotesUpdated(): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_PersonalEmotesUpdated);
}
...
@override
String toString() {
  return 'NetworkEvent.personalEmotesUpdated()';
}
...
class NetworkEvent_ServerJoinParked extends NetworkEvent {
  const NetworkEvent_ServerJoinParked({required this.serverId}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_ServerJoinParkedCopyWith<NetworkEvent_ServerJoinParked> get copyWith => _$NetworkEvent_ServerJoinParkedCopyWithImpl<NetworkEvent_ServerJoinParked>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_ServerJoinParked&&(identical(other.serverId, serverId) || other.serverId == serverId));
}
...
@override
String toString() {
  return 'NetworkEvent.serverJoinParked(serverId: $serverId)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_ServerJoinParkedCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_ServerJoinParkedCopyWith(NetworkEvent_ServerJoinParked value, $Res Function(NetworkEvent_ServerJoinParked) _then) = _$NetworkEvent_ServerJoinParkedCopyWithImpl;
@useResult
$Res call({
 String serverId
});
...
/// @nodoc
class _$NetworkEvent_ServerJoinParkedCopyWithImpl<$Res>
    implements $NetworkEvent_ServerJoinParkedCopyWith<$Res> {
  _$NetworkEvent_ServerJoinParkedCopyWithImpl(this._self, this._then);

  final NetworkEvent_ServerJoinParked _self;
  final $Res Function(NetworkEvent_ServerJoinParked) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? serverId = null,}) {
  return _then(NetworkEvent_ServerJoinParked(
serverId: null == serverId ? _self.serverId : serverId // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class NetworkEvent_PendingJoinUpdated extends NetworkEvent {
  const NetworkEvent_PendingJoinUpdated({required this.serverId, required this.state, required this.reason}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_PendingJoinUpdatedCopyWith<NetworkEvent_PendingJoinUpdated> get copyWith => _$NetworkEvent_PendingJoinUpdatedCopyWithImpl<NetworkEvent_PendingJoinUpdated>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_PendingJoinUpdated&&(identical(other.serverId, serverId) || other.serverId == serverId)&&(identical(other.state, state) || other.state == state)&&(identical(other.reason, reason) || other.reason == reason));
}


@override
int get hashCode => Object.hash(runtimeType,serverId,state,reason);

@override
String toString() {
  return 'NetworkEvent.pendingJoinUpdated(serverId: $serverId, state: $state, reason: $reason)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_PendingJoinUpdatedCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_PendingJoinUpdatedCopyWith(NetworkEvent_PendingJoinUpdated value, $Res Function(NetworkEvent_PendingJoinUpdated) _then) = _$NetworkEvent_PendingJoinUpdatedCopyWithImpl;
@useResult
$Res call({
 String serverId, String state, String reason
});
...
/// @nodoc
class _$NetworkEvent_PendingJoinUpdatedCopyWithImpl<$Res>
    implements $NetworkEvent_PendingJoinUpdatedCopyWith<$Res> {
  _$NetworkEvent_PendingJoinUpdatedCopyWithImpl(this._self, this._then);

  final NetworkEvent_PendingJoinUpdated _self;
  final $Res Function(NetworkEvent_PendingJoinUpdated) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? serverId = null,Object? state = null,Object? reason = null,}) {
  return _then(NetworkEvent_PendingJoinUpdated(
serverId: null == serverId ? _self.serverId : serverId // ignore: cast_nullable_to_non_nullable
...
class NetworkEvent_DeviceListUpdated extends NetworkEvent {
  const NetworkEvent_DeviceListUpdated({required this.masterPeerId}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_DeviceListUpdatedCopyWith<NetworkEvent_DeviceListUpdated> get copyWith => _$NetworkEvent_DeviceListUpdatedCopyWithImpl<NetworkEvent_DeviceListUpdated>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_DeviceListUpdated&&(identical(other.masterPeerId, masterPeerId) || other.masterPeerId == masterPeerId));
}


@override
int get hashCode => Object.hash(runtimeType,masterPeerId);

@override
String toString() {
  return 'NetworkEvent.deviceListUpdated(masterPeerId: $masterPeerId)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_DeviceListUpdatedCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_DeviceListUpdatedCopyWith(NetworkEvent_DeviceListUpdated value, $Res Function(NetworkEvent_DeviceListUpdated) _then) = _$NetworkEvent_DeviceListUpdatedCopyWithImpl;
@useResult
$Res call({
 String masterPeerId
});
...
/// @nodoc
class _$NetworkEvent_DeviceListUpdatedCopyWithImpl<$Res>
    implements $NetworkEvent_DeviceListUpdatedCopyWith<$Res> {
  _$NetworkEvent_DeviceListUpdatedCopyWithImpl(this._self, this._then);

  final NetworkEvent_DeviceListUpdated _self;
  final $Res Function(NetworkEvent_DeviceListUpdated) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? masterPeerId = null,}) {
  return _then(NetworkEvent_DeviceListUpdated(
masterPeerId: null == masterPeerId ? _self.masterPeerId : masterPeerId // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class NetworkEvent_ReadMarkersReceived extends NetworkEvent {
  const NetworkEvent_ReadMarkersReceived({required final  List<ReadMarkerEntry> markers}): _markers = markers,super._();
  

 final  List<ReadMarkerEntry> _markers;
 List<ReadMarkerEntry> get markers {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_ReadMarkersReceivedCopyWith<NetworkEvent_ReadMarkersReceived> get copyWith => _$NetworkEvent_ReadMarkersReceivedCopyWithImpl<NetworkEvent_ReadMarkersReceived>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_ReadMarkersReceived&&const DeepCollectionEquality().equals(other._markers, _markers));
}
...
@override
String toString() {
  return 'NetworkEvent.readMarkersReceived(markers: $markers)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_ReadMarkersReceivedCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_ReadMarkersReceivedCopyWith(NetworkEvent_ReadMarkersReceived value, $Res Function(NetworkEvent_ReadMarkersReceived) _then) = _$NetworkEvent_ReadMarkersReceivedCopyWithImpl;
@useResult
$Res call({
 List<ReadMarkerEntry> markers
});
...
/// @nodoc
class _$NetworkEvent_ReadMarkersReceivedCopyWithImpl<$Res>
    implements $NetworkEvent_ReadMarkersReceivedCopyWith<$Res> {
  _$NetworkEvent_ReadMarkersReceivedCopyWithImpl(this._self, this._then);

  final NetworkEvent_ReadMarkersReceived _self;
  final $Res Function(NetworkEvent_ReadMarkersReceived) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? markers = null,}) {
  return _then(NetworkEvent_ReadMarkersReceived(
markers: null == markers ? _self._markers : markers // ignore: cast_nullable_to_non_nullable
as List<ReadMarkerEntry>,
  ));
}
...
class NetworkEvent_SecurityAlert extends NetworkEvent {
  const NetworkEvent_SecurityAlert({required this.peerId, required this.kind, required this.detail, required this.createdAt}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_SecurityAlertCopyWith<NetworkEvent_SecurityAlert> get copyWith => _$NetworkEvent_SecurityAlertCopyWithImpl<NetworkEvent_SecurityAlert>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_SecurityAlert&&(identical(other.peerId, peerId) || other.peerId == peerId)&&(identical(other.kind, kind) || other.kind == kind)&&(identical(other.detail, detail) || other.detail == detail)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}


@override
int get hashCode => Object.hash(runtimeType,peerId,kind,detail,createdAt);

@override
String toString() {
  return 'NetworkEvent.securityAlert(peerId: $peerId, kind: $kind, detail: $detail, createdAt: $createdAt)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_SecurityAlertCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_SecurityAlertCopyWith(NetworkEvent_SecurityAlert value, $Res Function(NetworkEvent_SecurityAlert) _then) = _$NetworkEvent_SecurityAlertCopyWithImpl;
@useResult
$Res call({
 String peerId, String kind, String detail, PlatformInt64 createdAt
});
...
/// @nodoc
class _$NetworkEvent_SecurityAlertCopyWithImpl<$Res>
    implements $NetworkEvent_SecurityAlertCopyWith<$Res> {
  _$NetworkEvent_SecurityAlertCopyWithImpl(this._self, this._then);

  final NetworkEvent_SecurityAlert _self;
  final $Res Function(NetworkEvent_SecurityAlert) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? peerId = null,Object? kind = null,Object? detail = null,Object? createdAt = null,}) {
  return _then(NetworkEvent_SecurityAlert(
peerId: null == peerId ? _self.peerId : peerId // ignore: cast_nullable_to_non_nullable
...
class NetworkEvent_SelfRevoked extends NetworkEvent {
  const NetworkEvent_SelfRevoked(): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_SelfRevoked);
}
...
@override
String toString() {
  return 'NetworkEvent.selfRevoked()';
}
...
class NetworkEvent_DestroyReceived extends NetworkEvent {
  const NetworkEvent_DestroyReceived({required this.scope}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_DestroyReceivedCopyWith<NetworkEvent_DestroyReceived> get copyWith => _$NetworkEvent_DestroyReceivedCopyWithImpl<NetworkEvent_DestroyReceived>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_DestroyReceived&&(identical(other.scope, scope) || other.scope == scope));
}
...
@override
String toString() {
  return 'NetworkEvent.destroyReceived(scope: $scope)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_DestroyReceivedCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_DestroyReceivedCopyWith(NetworkEvent_DestroyReceived value, $Res Function(NetworkEvent_DestroyReceived) _then) = _$NetworkEvent_DestroyReceivedCopyWithImpl;
@useResult
$Res call({
 String scope
});
...
/// @nodoc
class _$NetworkEvent_DestroyReceivedCopyWithImpl<$Res>
    implements $NetworkEvent_DestroyReceivedCopyWith<$Res> {
  _$NetworkEvent_DestroyReceivedCopyWithImpl(this._self, this._then);

  final NetworkEvent_DestroyReceived _self;
  final $Res Function(NetworkEvent_DestroyReceived) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? scope = null,}) {
  return _then(NetworkEvent_DestroyReceived(
...
class NetworkEvent_IdentityDestroyedByFriend extends NetworkEvent {
  const NetworkEvent_IdentityDestroyedByFriend({required this.masterPeerId, required this.issuedAtMs}): super._();
  

 final  String masterPeerId;
 final  PlatformInt64 issuedAtMs;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_IdentityDestroyedByFriendCopyWith<NetworkEvent_IdentityDestroyedByFriend> get copyWith => _$NetworkEvent_IdentityDestroyedByFriendCopyWithImpl<NetworkEvent_IdentityDestroyedByFriend>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_IdentityDestroyedByFriend&&(identical(other.masterPeerId, masterPeerId) || other.masterPeerId == masterPeerId)&&(identical(other.issuedAtMs, issuedAtMs) || other.issuedAtMs == issuedAtMs));
}


@override
int get hashCode => Object.hash(runtimeType,masterPeerId,issuedAtMs);

@override
String toString() {
  return 'NetworkEvent.identityDestroyedByFriend(masterPeerId: $masterPeerId, issuedAtMs: $issuedAtMs)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_IdentityDestroyedByFriendCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_IdentityDestroyedByFriendCopyWith(NetworkEvent_IdentityDestroyedByFriend value, $Res Function(NetworkEvent_IdentityDestroyedByFriend) _then) = _$NetworkEvent_IdentityDestroyedByFriendCopyWithImpl;
@useResult
$Res call({
 String masterPeerId, PlatformInt64 issuedAtMs
});
...
/// @nodoc
class _$NetworkEvent_IdentityDestroyedByFriendCopyWithImpl<$Res>
    implements $NetworkEvent_IdentityDestroyedByFriendCopyWith<$Res> {
  _$NetworkEvent_IdentityDestroyedByFriendCopyWithImpl(this._self, this._then);

  final NetworkEvent_IdentityDestroyedByFriend _self;
  final $Res Function(NetworkEvent_IdentityDestroyedByFriend) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? masterPeerId = null,Object? issuedAtMs = null,}) {
  return _then(NetworkEvent_IdentityDestroyedByFriend(
masterPeerId: null == masterPeerId ? _self.masterPeerId : masterPeerId // ignore: cast_nullable_to_non_nullable
as String,issuedAtMs: null == issuedAtMs ? _self.issuedAtMs : issuedAtMs // ignore: cast_nullable_to_non_nullable
as PlatformInt64,
  ));
}
...
class NetworkEvent_ChannelLinkPreviewUpdated extends NetworkEvent {
  const NetworkEvent_ChannelLinkPreviewUpdated({required this.serverId, required this.channelId, required this.messageId, this.preview}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_ChannelLinkPreviewUpdatedCopyWith<NetworkEvent_ChannelLinkPreviewUpdated> get copyWith => _$NetworkEvent_ChannelLinkPreviewUpdatedCopyWithImpl<NetworkEvent_ChannelLinkPreviewUpdated>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_ChannelLinkPreviewUpdated&&(identical(other.serverId, serverId) || other.serverId == serverId)&&(identical(other.channelId, channelId) || other.channelId == channelId)&&(identical(other.messageId, messageId) || other.messageId == messageId)&&(identical(other.preview, preview) || other.preview == preview));
}


@override
int get hashCode => Object.hash(runtimeType,serverId,channelId,messageId,preview);

@override
String toString() {
  return 'NetworkEvent.channelLinkPreviewUpdated(serverId: $serverId, channelId: $channelId, messageId: $messageId, preview: $preview)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_ChannelLinkPreviewUpdatedCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_ChannelLinkPreviewUpdatedCopyWith(NetworkEvent_ChannelLinkPreviewUpdated value, $Res Function(NetworkEvent_ChannelLinkPreviewUpdated) _then) = _$NetworkEvent_ChannelLinkPreviewUpdatedCopyWithImpl;
@useResult
$Res call({
 String serverId, String channelId, String messageId, LinkPreviewRef? preview
});
...
/// @nodoc
class _$NetworkEvent_ChannelLinkPreviewUpdatedCopyWithImpl<$Res>
    implements $NetworkEvent_ChannelLinkPreviewUpdatedCopyWith<$Res> {
  _$NetworkEvent_ChannelLinkPreviewUpdatedCopyWithImpl(this._self, this._then);

  final NetworkEvent_ChannelLinkPreviewUpdated _self;
  final $Res Function(NetworkEvent_ChannelLinkPreviewUpdated) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? serverId = null,Object? channelId = null,Object? messageId = null,Object? preview = freezed,}) {
  return _then(NetworkEvent_ChannelLinkPreviewUpdated(
serverId: null == serverId ? _self.serverId : serverId // ignore: cast_nullable_to_non_nullable
as String,channelId: null == channelId ? _self.channelId : channelId // ignore: cast_nullable_to_non_nullable
as String,messageId: null == messageId ? _self.messageId : messageId // ignore: cast_nullable_to_non_nullable
...
class NetworkEvent_DmLinkPreviewUpdated extends NetworkEvent {
  const NetworkEvent_DmLinkPreviewUpdated({required this.peerId, required this.messageId, this.preview}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_DmLinkPreviewUpdatedCopyWith<NetworkEvent_DmLinkPreviewUpdated> get copyWith => _$NetworkEvent_DmLinkPreviewUpdatedCopyWithImpl<NetworkEvent_DmLinkPreviewUpdated>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_DmLinkPreviewUpdated&&(identical(other.peerId, peerId) || other.peerId == peerId)&&(identical(other.messageId, messageId) || other.messageId == messageId)&&(identical(other.preview, preview) || other.preview == preview));
}


@override
int get hashCode => Object.hash(runtimeType,peerId,messageId,preview);

@override
String toString() {
  return 'NetworkEvent.dmLinkPreviewUpdated(peerId: $peerId, messageId: $messageId, preview: $preview)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_DmLinkPreviewUpdatedCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_DmLinkPreviewUpdatedCopyWith(NetworkEvent_DmLinkPreviewUpdated value, $Res Function(NetworkEvent_DmLinkPreviewUpdated) _then) = _$NetworkEvent_DmLinkPreviewUpdatedCopyWithImpl;
@useResult
$Res call({
 String peerId, String messageId, LinkPreviewRef? preview
});
...
/// @nodoc
class _$NetworkEvent_DmLinkPreviewUpdatedCopyWithImpl<$Res>
    implements $NetworkEvent_DmLinkPreviewUpdatedCopyWith<$Res> {
  _$NetworkEvent_DmLinkPreviewUpdatedCopyWithImpl(this._self, this._then);

  final NetworkEvent_DmLinkPreviewUpdated _self;
  final $Res Function(NetworkEvent_DmLinkPreviewUpdated) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? peerId = null,Object? messageId = null,Object? preview = freezed,}) {
  return _then(NetworkEvent_DmLinkPreviewUpdated(
peerId: null == peerId ? _self.peerId : peerId // ignore: cast_nullable_to_non_nullable
as String,messageId: null == messageId ? _self.messageId : messageId // ignore: cast_nullable_to_non_nullable
as String,preview: freezed == preview ? _self.preview : preview // ignore: cast_nullable_to_non_nullable
as LinkPreviewRef?,
...
class NetworkEvent_FriendsBackfilled extends NetworkEvent {
  const NetworkEvent_FriendsBackfilled({required this.count}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_FriendsBackfilledCopyWith<NetworkEvent_FriendsBackfilled> get copyWith => _$NetworkEvent_FriendsBackfilledCopyWithImpl<NetworkEvent_FriendsBackfilled>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_FriendsBackfilled&&(identical(other.count, count) || other.count == count));
}
...
@override
String toString() {
  return 'NetworkEvent.friendsBackfilled(count: $count)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_FriendsBackfilledCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_FriendsBackfilledCopyWith(NetworkEvent_FriendsBackfilled value, $Res Function(NetworkEvent_FriendsBackfilled) _then) = _$NetworkEvent_FriendsBackfilledCopyWithImpl;
@useResult
$Res call({
 int count
});
...
/// @nodoc
class _$NetworkEvent_FriendsBackfilledCopyWithImpl<$Res>
    implements $NetworkEvent_FriendsBackfilledCopyWith<$Res> {
  _$NetworkEvent_FriendsBackfilledCopyWithImpl(this._self, this._then);

  final NetworkEvent_FriendsBackfilled _self;
  final $Res Function(NetworkEvent_FriendsBackfilled) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? count = null,}) {
  return _then(NetworkEvent_FriendsBackfilled(
...
class NetworkEvent_NicknameClaimed extends NetworkEvent {
  const NetworkEvent_NicknameClaimed({required this.nickname}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_NicknameClaimedCopyWith<NetworkEvent_NicknameClaimed> get copyWith => _$NetworkEvent_NicknameClaimedCopyWithImpl<NetworkEvent_NicknameClaimed>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_NicknameClaimed&&(identical(other.nickname, nickname) || other.nickname == nickname));
}
...
@override
String toString() {
  return 'NetworkEvent.nicknameClaimed(nickname: $nickname)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_NicknameClaimedCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_NicknameClaimedCopyWith(NetworkEvent_NicknameClaimed value, $Res Function(NetworkEvent_NicknameClaimed) _then) = _$NetworkEvent_NicknameClaimedCopyWithImpl;
@useResult
$Res call({
 String nickname
});
...
/// @nodoc
class _$NetworkEvent_NicknameClaimedCopyWithImpl<$Res>
    implements $NetworkEvent_NicknameClaimedCopyWith<$Res> {
  _$NetworkEvent_NicknameClaimedCopyWithImpl(this._self, this._then);

  final NetworkEvent_NicknameClaimed _self;
  final $Res Function(NetworkEvent_NicknameClaimed) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? nickname = null,}) {
  return _then(NetworkEvent_NicknameClaimed(
...
class NetworkEvent_NicknameReleased extends NetworkEvent {
  const NetworkEvent_NicknameReleased(): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_NicknameReleased);
}
...
@override
String toString() {
  return 'NetworkEvent.nicknameReleased()';
}
...
class NetworkEvent_NicknameClaimFailed extends NetworkEvent {
  const NetworkEvent_NicknameClaimFailed({required this.error}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_NicknameClaimFailedCopyWith<NetworkEvent_NicknameClaimFailed> get copyWith => _$NetworkEvent_NicknameClaimFailedCopyWithImpl<NetworkEvent_NicknameClaimFailed>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_NicknameClaimFailed&&(identical(other.error, error) || other.error == error));
}
...
@override
String toString() {
  return 'NetworkEvent.nicknameClaimFailed(error: $error)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_NicknameClaimFailedCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_NicknameClaimFailedCopyWith(NetworkEvent_NicknameClaimFailed value, $Res Function(NetworkEvent_NicknameClaimFailed) _then) = _$NetworkEvent_NicknameClaimFailedCopyWithImpl;
@useResult
$Res call({
 String error
});
...
/// @nodoc
class _$NetworkEvent_NicknameClaimFailedCopyWithImpl<$Res>
    implements $NetworkEvent_NicknameClaimFailedCopyWith<$Res> {
  _$NetworkEvent_NicknameClaimFailedCopyWithImpl(this._self, this._then);

  final NetworkEvent_NicknameClaimFailed _self;
  final $Res Function(NetworkEvent_NicknameClaimFailed) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? error = null,}) {
  return _then(NetworkEvent_NicknameClaimFailed(
...
class NetworkEvent_NicknameResolveFailed extends NetworkEvent {
  const NetworkEvent_NicknameResolveFailed({required this.nickname, required this.error}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_NicknameResolveFailedCopyWith<NetworkEvent_NicknameResolveFailed> get copyWith => _$NetworkEvent_NicknameResolveFailedCopyWithImpl<NetworkEvent_NicknameResolveFailed>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_NicknameResolveFailed&&(identical(other.nickname, nickname) || other.nickname == nickname)&&(identical(other.error, error) || other.error == error));
}


@override
int get hashCode => Object.hash(runtimeType,nickname,error);

@override
String toString() {
  return 'NetworkEvent.nicknameResolveFailed(nickname: $nickname, error: $error)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_NicknameResolveFailedCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_NicknameResolveFailedCopyWith(NetworkEvent_NicknameResolveFailed value, $Res Function(NetworkEvent_NicknameResolveFailed) _then) = _$NetworkEvent_NicknameResolveFailedCopyWithImpl;
@useResult
$Res call({
 String nickname, String error
});
...
/// @nodoc
class _$NetworkEvent_NicknameResolveFailedCopyWithImpl<$Res>
    implements $NetworkEvent_NicknameResolveFailedCopyWith<$Res> {
  _$NetworkEvent_NicknameResolveFailedCopyWithImpl(this._self, this._then);

  final NetworkEvent_NicknameResolveFailed _self;
  final $Res Function(NetworkEvent_NicknameResolveFailed) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? nickname = null,Object? error = null,}) {
  return _then(NetworkEvent_NicknameResolveFailed(
nickname: null == nickname ? _self.nickname : nickname // ignore: cast_nullable_to_non_nullable
as String,error: null == error ? _self.error : error // ignore: cast_nullable_to_non_nullable
as String,
  ));
...
class NetworkEvent_RelayDisconnected extends NetworkEvent {
  const NetworkEvent_RelayDisconnected(): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_RelayDisconnected);
}
...
@override
String toString() {
  return 'NetworkEvent.relayDisconnected()';
}
...
class NetworkEvent_RelayConnected extends NetworkEvent {
  const NetworkEvent_RelayConnected(): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_RelayConnected);
}
...
@override
String toString() {
  return 'NetworkEvent.relayConnected()';
}
...
class NetworkEvent_RelayConnecting extends NetworkEvent {
  const NetworkEvent_RelayConnecting({required this.reconnecting}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_RelayConnectingCopyWith<NetworkEvent_RelayConnecting> get copyWith => _$NetworkEvent_RelayConnectingCopyWithImpl<NetworkEvent_RelayConnecting>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_RelayConnecting&&(identical(other.reconnecting, reconnecting) || other.reconnecting == reconnecting));
}
...
@override
String toString() {
  return 'NetworkEvent.relayConnecting(reconnecting: $reconnecting)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_RelayConnectingCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_RelayConnectingCopyWith(NetworkEvent_RelayConnecting value, $Res Function(NetworkEvent_RelayConnecting) _then) = _$NetworkEvent_RelayConnectingCopyWithImpl;
@useResult
$Res call({
 bool reconnecting
});
...
/// @nodoc
class _$NetworkEvent_RelayConnectingCopyWithImpl<$Res>
    implements $NetworkEvent_RelayConnectingCopyWith<$Res> {
  _$NetworkEvent_RelayConnectingCopyWithImpl(this._self, this._then);

  final NetworkEvent_RelayConnecting _self;
  final $Res Function(NetworkEvent_RelayConnecting) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? reconnecting = null,}) {
  return _then(NetworkEvent_RelayConnecting(
reconnecting: null == reconnecting ? _self.reconnecting : reconnecting // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
class NetworkEvent_ChannelNotificationHint extends NetworkEvent {
  const NetworkEvent_ChannelNotificationHint({required this.serverId, required this.channelId, required this.fromPeer, required this.messageId, required this.hasEveryone, required final  List<String> mentionedNames, required this.isReplyToOwn}): _mentionedNames = mentionedNames,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_ChannelNotificationHint&&(identical(other.serverId, serverId) || other.serverId == serverId)&&(identical(other.channelId, channelId) || other.channelId == channelId)&&(identical(other.fromPeer, fromPeer) || other.fromPeer == fromPeer)&&(identical(other.messageId, messageId) || other.messageId == messageId)&&(identical(other.hasEveryone, hasEveryone) || other.hasEveryone == hasEveryone)&&const DeepCollectionEquality().equals(other._mentionedNames, _mentionedNames)&&(identical(other.isReplyToOwn, isReplyToOwn) || other.isReplyToOwn == isReplyToOwn));
}


@override
int get hashCode => Object.hash(runtimeType,serverId,channelId,fromPeer,messageId,hasEveryone,const DeepCollectionEquality().hash(_mentionedNames),isReplyToOwn);

@override
String toString() {
  return 'NetworkEvent.channelNotificationHint(serverId: $serverId, channelId: $channelId, fromPeer: $fromPeer, messageId: $messageId, hasEveryone: $hasEveryone, mentionedNames: $mentionedNames, isReplyToOwn: $isReplyToOwn)';
}
...
@useResult
$Res call({
 String serverId, String channelId, String fromPeer, String messageId, bool hasEveryone, List<String> mentionedNames, bool isReplyToOwn
});
...
/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? serverId = null,Object? channelId = null,Object? fromPeer = null,Object? messageId = null,Object? hasEveryone = null,Object? mentionedNames = null,Object? isReplyToOwn = null,}) {
...
as List<String>,isReplyToOwn: null == isReplyToOwn ? _self.isReplyToOwn : isReplyToOwn // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
class NetworkEvent_FileHeaderReceived extends NetworkEvent {
  const NetworkEvent_FileHeaderReceived({required this.fileId, required this.fileName, required this.sizeBytes, required this.isImage, this.width, this.height, required this.messageId, required this.senderId, required this.serverId, required this.channelId, this.videoThumb, this.shareRootHash, this.shareKeyHex, this.thumbB64}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_FileHeaderReceived&&(identical(other.fileId, fileId) || other.fileId == fileId)&&(identical(other.fileName, fileName) || other.fileName == fileName)&&(identical(other.sizeBytes, sizeBytes) || other.sizeBytes == sizeBytes)&&(identical(other.isImage, isImage) || other.isImage == isImage)&&(identical(other.width, width) || other.width == width)&&(identical(other.height, height) || other.height == height)&&(identical(other.messageId, messageId) || other.messageId == messageId)&&(identical(other.senderId, senderId) || other.senderId == senderId)&&(identical(other.serverId, serverId) || other.serverId == serverId)&&(identical(other.channelId, channelId) || other.channelId == channelId)&&(identical(other.videoThumb, videoThumb) || other.videoThumb == videoThumb)&&(identical(other.shareRootHash, shareRootHash) || other.shareRootHash == shareRootHash)&&(identical(other.shareKeyHex, shareKeyHex) || other.shareKeyHex == shareKeyHex)&&(identical(other.thumbB64, thumbB64) || other.thumbB64 == thumbB64));
}


@override
int get hashCode => Object.hash(runtimeType,fileId,fileName,sizeBytes,isImage,width,height,messageId,senderId,serverId,channelId,videoThumb,shareRootHash,shareKeyHex,thumbB64);

@override
String toString() {
  return 'NetworkEvent.fileHeaderReceived(fileId: $fileId, fileName: $fileName, sizeBytes: $sizeBytes, isImage: $isImage, width: $width, height: $height, messageId: $messageId, senderId: $senderId, serverId: $serverId, channelId: $channelId, videoThumb: $videoThumb, shareRootHash: $shareRootHash, shareKeyHex: $shareKeyHex, thumbB64: $thumbB64)';
}
...
@useResult
$Res call({
 String fileId, String fileName, BigInt sizeBytes, bool isImage, int? width, int? height, String messageId, String senderId, String serverId, String channelId, VideoThumbRef? videoThumb, String? shareRootHash, String? shareKeyHex, String? thumbB64
});
...
/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? fileId = null,Object? fileName = null,Object? sizeBytes = null,Object? isImage = null,Object? width = freezed,Object? height = freezed,Object? messageId = null,Object? senderId = null,Object? serverId = null,Object? channelId = null,Object? videoThumb = freezed,Object? shareRootHash = freezed,Object? shareKeyHex = freezed,Object? thumbB64 = freezed,}) {
...
as String?,thumbB64: freezed == thumbB64 ? _self.thumbB64 : thumbB64 // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
class NetworkEvent_FileAvailability extends NetworkEvent {
  const NetworkEvent_FileAvailability({required this.fileId, required this.state, required this.peerId}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_FileAvailabilityCopyWith<NetworkEvent_FileAvailability> get copyWith => _$NetworkEvent_FileAvailabilityCopyWithImpl<NetworkEvent_FileAvailability>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_FileAvailability&&(identical(other.fileId, fileId) || other.fileId == fileId)&&(identical(other.state, state) || other.state == state)&&(identical(other.peerId, peerId) || other.peerId == peerId));
}


@override
int get hashCode => Object.hash(runtimeType,fileId,state,peerId);

@override
String toString() {
  return 'NetworkEvent.fileAvailability(fileId: $fileId, state: $state, peerId: $peerId)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_FileAvailabilityCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_FileAvailabilityCopyWith(NetworkEvent_FileAvailability value, $Res Function(NetworkEvent_FileAvailability) _then) = _$NetworkEvent_FileAvailabilityCopyWithImpl;
@useResult
$Res call({
 String fileId, String state, String peerId
});
...
/// @nodoc
class _$NetworkEvent_FileAvailabilityCopyWithImpl<$Res>
    implements $NetworkEvent_FileAvailabilityCopyWith<$Res> {
  _$NetworkEvent_FileAvailabilityCopyWithImpl(this._self, this._then);

  final NetworkEvent_FileAvailability _self;
  final $Res Function(NetworkEvent_FileAvailability) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? fileId = null,Object? state = null,Object? peerId = null,}) {
  return _then(NetworkEvent_FileAvailability(
fileId: null == fileId ? _self.fileId : fileId // ignore: cast_nullable_to_non_nullable
as String,state: null == state ? _self.state : state // ignore: cast_nullable_to_non_nullable
as String,peerId: null == peerId ? _self.peerId : peerId // ignore: cast_nullable_to_non_nullable
as String,
...
class NetworkEvent_TurnCredentials extends NetworkEvent {
  const NetworkEvent_TurnCredentials({required this.username, required this.password, required this.ttl, required final  List<String> uris}): _uris = uris,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_TurnCredentialsCopyWith<NetworkEvent_TurnCredentials> get copyWith => _$NetworkEvent_TurnCredentialsCopyWithImpl<NetworkEvent_TurnCredentials>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_TurnCredentials&&(identical(other.username, username) || other.username == username)&&(identical(other.password, password) || other.password == password)&&(identical(other.ttl, ttl) || other.ttl == ttl)&&const DeepCollectionEquality().equals(other._uris, _uris));
}


@override
int get hashCode => Object.hash(runtimeType,username,password,ttl,const DeepCollectionEquality().hash(_uris));

@override
String toString() {
  return 'NetworkEvent.turnCredentials(username: $username, password: $password, ttl: $ttl, uris: $uris)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_TurnCredentialsCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_TurnCredentialsCopyWith(NetworkEvent_TurnCredentials value, $Res Function(NetworkEvent_TurnCredentials) _then) = _$NetworkEvent_TurnCredentialsCopyWithImpl;
@useResult
$Res call({
 String username, String password, BigInt ttl, List<String> uris
});
...
/// @nodoc
class _$NetworkEvent_TurnCredentialsCopyWithImpl<$Res>
    implements $NetworkEvent_TurnCredentialsCopyWith<$Res> {
  _$NetworkEvent_TurnCredentialsCopyWithImpl(this._self, this._then);

  final NetworkEvent_TurnCredentials _self;
  final $Res Function(NetworkEvent_TurnCredentials) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? username = null,Object? password = null,Object? ttl = null,Object? uris = null,}) {
  return _then(NetworkEvent_TurnCredentials(
username: null == username ? _self.username : username // ignore: cast_nullable_to_non_nullable
as String,password: null == password ? _self.password : password // ignore: cast_nullable_to_non_nullable
as String,ttl: null == ttl ? _self.ttl : ttl // ignore: cast_nullable_to_non_nullable
as BigInt,uris: null == uris ? _self._uris : uris // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
...
class NetworkEvent_LinkCodeClaimed extends NetworkEvent {
  const NetworkEvent_LinkCodeClaimed({required this.code}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_LinkCodeClaimedCopyWith<NetworkEvent_LinkCodeClaimed> get copyWith => _$NetworkEvent_LinkCodeClaimedCopyWithImpl<NetworkEvent_LinkCodeClaimed>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_LinkCodeClaimed&&(identical(other.code, code) || other.code == code));
}
...
@override
String toString() {
  return 'NetworkEvent.linkCodeClaimed(code: $code)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_LinkCodeClaimedCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_LinkCodeClaimedCopyWith(NetworkEvent_LinkCodeClaimed value, $Res Function(NetworkEvent_LinkCodeClaimed) _then) = _$NetworkEvent_LinkCodeClaimedCopyWithImpl;
@useResult
$Res call({
 String code
});
...
/// @nodoc
class _$NetworkEvent_LinkCodeClaimedCopyWithImpl<$Res>
    implements $NetworkEvent_LinkCodeClaimedCopyWith<$Res> {
  _$NetworkEvent_LinkCodeClaimedCopyWithImpl(this._self, this._then);

  final NetworkEvent_LinkCodeClaimed _self;
  final $Res Function(NetworkEvent_LinkCodeClaimed) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? code = null,}) {
  return _then(NetworkEvent_LinkCodeClaimed(
...
class NetworkEvent_LinkCodeError extends NetworkEvent {
  const NetworkEvent_LinkCodeError({required this.error, required this.code}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_LinkCodeErrorCopyWith<NetworkEvent_LinkCodeError> get copyWith => _$NetworkEvent_LinkCodeErrorCopyWithImpl<NetworkEvent_LinkCodeError>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_LinkCodeError&&(identical(other.error, error) || other.error == error)&&(identical(other.code, code) || other.code == code));
}
...
@override
String toString() {
  return 'NetworkEvent.linkCodeError(error: $error, code: $code)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_LinkCodeErrorCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_LinkCodeErrorCopyWith(NetworkEvent_LinkCodeError value, $Res Function(NetworkEvent_LinkCodeError) _then) = _$NetworkEvent_LinkCodeErrorCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$NetworkEvent_LinkCodeErrorCopyWithImpl<$Res>
    implements $NetworkEvent_LinkCodeErrorCopyWith<$Res> {
  _$NetworkEvent_LinkCodeErrorCopyWithImpl(this._self, this._then);

  final NetworkEvent_LinkCodeError _self;
  final $Res Function(NetworkEvent_LinkCodeError) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? error = null,Object? code = null,}) {
  return _then(NetworkEvent_LinkCodeError(
error: null == error ? _self.error : error // ignore: cast_nullable_to_non_nullable
...
class NetworkEvent_SiblingLinkAvailable extends NetworkEvent {
  const NetworkEvent_SiblingLinkAvailable({required this.peerId, required this.theirMsgCount, required this.theirFriendCount, required this.theirHasProfile}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_SiblingLinkAvailableCopyWith<NetworkEvent_SiblingLinkAvailable> get copyWith => _$NetworkEvent_SiblingLinkAvailableCopyWithImpl<NetworkEvent_SiblingLinkAvailable>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_SiblingLinkAvailable&&(identical(other.peerId, peerId) || other.peerId == peerId)&&(identical(other.theirMsgCount, theirMsgCount) || other.theirMsgCount == theirMsgCount)&&(identical(other.theirFriendCount, theirFriendCount) || other.theirFriendCount == theirFriendCount)&&(identical(other.theirHasProfile, theirHasProfile) || other.theirHasProfile == theirHasProfile));
}


@override
int get hashCode => Object.hash(runtimeType,peerId,theirMsgCount,theirFriendCount,theirHasProfile);

@override
String toString() {
  return 'NetworkEvent.siblingLinkAvailable(peerId: $peerId, theirMsgCount: $theirMsgCount, theirFriendCount: $theirFriendCount, theirHasProfile: $theirHasProfile)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_SiblingLinkAvailableCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_SiblingLinkAvailableCopyWith(NetworkEvent_SiblingLinkAvailable value, $Res Function(NetworkEvent_SiblingLinkAvailable) _then) = _$NetworkEvent_SiblingLinkAvailableCopyWithImpl;
@useResult
$Res call({
 String peerId, int theirMsgCount, int theirFriendCount, bool theirHasProfile
});
...
/// @nodoc
class _$NetworkEvent_SiblingLinkAvailableCopyWithImpl<$Res>
    implements $NetworkEvent_SiblingLinkAvailableCopyWith<$Res> {
  _$NetworkEvent_SiblingLinkAvailableCopyWithImpl(this._self, this._then);

  final NetworkEvent_SiblingLinkAvailable _self;
  final $Res Function(NetworkEvent_SiblingLinkAvailable) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? peerId = null,Object? theirMsgCount = null,Object? theirFriendCount = null,Object? theirHasProfile = null,}) {
  return _then(NetworkEvent_SiblingLinkAvailable(
peerId: null == peerId ? _self.peerId : peerId // ignore: cast_nullable_to_non_nullable
as String,theirMsgCount: null == theirMsgCount ? _self.theirMsgCount : theirMsgCount // ignore: cast_nullable_to_non_nullable
as int,theirFriendCount: null == theirFriendCount ? _self.theirFriendCount : theirFriendCount // ignore: cast_nullable_to_non_nullable
as int,theirHasProfile: null == theirHasProfile ? _self.theirHasProfile : theirHasProfile // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
class NetworkEvent_LinkProgress extends NetworkEvent {
  const NetworkEvent_LinkProgress({required this.linkId, required this.bytesReceived, required this.totalBytes}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_LinkProgressCopyWith<NetworkEvent_LinkProgress> get copyWith => _$NetworkEvent_LinkProgressCopyWithImpl<NetworkEvent_LinkProgress>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_LinkProgress&&(identical(other.linkId, linkId) || other.linkId == linkId)&&(identical(other.bytesReceived, bytesReceived) || other.bytesReceived == bytesReceived)&&(identical(other.totalBytes, totalBytes) || other.totalBytes == totalBytes));
}


@override
int get hashCode => Object.hash(runtimeType,linkId,bytesReceived,totalBytes);

@override
String toString() {
  return 'NetworkEvent.linkProgress(linkId: $linkId, bytesReceived: $bytesReceived, totalBytes: $totalBytes)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_LinkProgressCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_LinkProgressCopyWith(NetworkEvent_LinkProgress value, $Res Function(NetworkEvent_LinkProgress) _then) = _$NetworkEvent_LinkProgressCopyWithImpl;
@useResult
$Res call({
 String linkId, BigInt bytesReceived, BigInt totalBytes
});
...
/// @nodoc
class _$NetworkEvent_LinkProgressCopyWithImpl<$Res>
    implements $NetworkEvent_LinkProgressCopyWith<$Res> {
  _$NetworkEvent_LinkProgressCopyWithImpl(this._self, this._then);

  final NetworkEvent_LinkProgress _self;
  final $Res Function(NetworkEvent_LinkProgress) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? linkId = null,Object? bytesReceived = null,Object? totalBytes = null,}) {
  return _then(NetworkEvent_LinkProgress(
...
class NetworkEvent_LinkComplete extends NetworkEvent {
  const NetworkEvent_LinkComplete({required this.linkId, required this.msgCount, required this.friendCount, required this.serverCount}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_LinkCompleteCopyWith<NetworkEvent_LinkComplete> get copyWith => _$NetworkEvent_LinkCompleteCopyWithImpl<NetworkEvent_LinkComplete>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_LinkComplete&&(identical(other.linkId, linkId) || other.linkId == linkId)&&(identical(other.msgCount, msgCount) || other.msgCount == msgCount)&&(identical(other.friendCount, friendCount) || other.friendCount == friendCount)&&(identical(other.serverCount, serverCount) || other.serverCount == serverCount));
}


@override
int get hashCode => Object.hash(runtimeType,linkId,msgCount,friendCount,serverCount);

@override
String toString() {
  return 'NetworkEvent.linkComplete(linkId: $linkId, msgCount: $msgCount, friendCount: $friendCount, serverCount: $serverCount)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_LinkCompleteCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_LinkCompleteCopyWith(NetworkEvent_LinkComplete value, $Res Function(NetworkEvent_LinkComplete) _then) = _$NetworkEvent_LinkCompleteCopyWithImpl;
@useResult
$Res call({
 String linkId, int msgCount, int friendCount, int serverCount
});
...
/// @nodoc
class _$NetworkEvent_LinkCompleteCopyWithImpl<$Res>
    implements $NetworkEvent_LinkCompleteCopyWith<$Res> {
  _$NetworkEvent_LinkCompleteCopyWithImpl(this._self, this._then);

  final NetworkEvent_LinkComplete _self;
  final $Res Function(NetworkEvent_LinkComplete) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? linkId = null,Object? msgCount = null,Object? friendCount = null,Object? serverCount = null,}) {
  return _then(NetworkEvent_LinkComplete(
linkId: null == linkId ? _self.linkId : linkId // ignore: cast_nullable_to_non_nullable
as String,msgCount: null == msgCount ? _self.msgCount : msgCount // ignore: cast_nullable_to_non_nullable
as int,friendCount: null == friendCount ? _self.friendCount : friendCount // ignore: cast_nullable_to_non_nullable
as int,serverCount: null == serverCount ? _self.serverCount : serverCount // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
class NetworkEvent_LinkFailed extends NetworkEvent {
  const NetworkEvent_LinkFailed({required this.linkId, required this.error}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_LinkFailedCopyWith<NetworkEvent_LinkFailed> get copyWith => _$NetworkEvent_LinkFailedCopyWithImpl<NetworkEvent_LinkFailed>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_LinkFailed&&(identical(other.linkId, linkId) || other.linkId == linkId)&&(identical(other.error, error) || other.error == error));
}


@override
int get hashCode => Object.hash(runtimeType,linkId,error);

@override
String toString() {
  return 'NetworkEvent.linkFailed(linkId: $linkId, error: $error)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_LinkFailedCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_LinkFailedCopyWith(NetworkEvent_LinkFailed value, $Res Function(NetworkEvent_LinkFailed) _then) = _$NetworkEvent_LinkFailedCopyWithImpl;
@useResult
$Res call({
 String linkId, String error
});
...
/// @nodoc
class _$NetworkEvent_LinkFailedCopyWithImpl<$Res>
    implements $NetworkEvent_LinkFailedCopyWith<$Res> {
  _$NetworkEvent_LinkFailedCopyWithImpl(this._self, this._then);

  final NetworkEvent_LinkFailed _self;
  final $Res Function(NetworkEvent_LinkFailed) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? linkId = null,Object? error = null,}) {
  return _then(NetworkEvent_LinkFailed(
linkId: null == linkId ? _self.linkId : linkId // ignore: cast_nullable_to_non_nullable
as String,error: null == error ? _self.error : error // ignore: cast_nullable_to_non_nullable
as String,
  ));
...
class NetworkEvent_LinkPushComplete extends NetworkEvent {
  const NetworkEvent_LinkPushComplete({required this.bytes}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_LinkPushCompleteCopyWith<NetworkEvent_LinkPushComplete> get copyWith => _$NetworkEvent_LinkPushCompleteCopyWithImpl<NetworkEvent_LinkPushComplete>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_LinkPushComplete&&(identical(other.bytes, bytes) || other.bytes == bytes));
}
...
@override
String toString() {
  return 'NetworkEvent.linkPushComplete(bytes: $bytes)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_LinkPushCompleteCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_LinkPushCompleteCopyWith(NetworkEvent_LinkPushComplete value, $Res Function(NetworkEvent_LinkPushComplete) _then) = _$NetworkEvent_LinkPushCompleteCopyWithImpl;
@useResult
$Res call({
 BigInt bytes
});
...
/// @nodoc
class _$NetworkEvent_LinkPushCompleteCopyWithImpl<$Res>
    implements $NetworkEvent_LinkPushCompleteCopyWith<$Res> {
  _$NetworkEvent_LinkPushCompleteCopyWithImpl(this._self, this._then);

  final NetworkEvent_LinkPushComplete _self;
  final $Res Function(NetworkEvent_LinkPushComplete) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? bytes = null,}) {
  return _then(NetworkEvent_LinkPushComplete(
...
class NetworkEvent_VoiceChannelJoined extends NetworkEvent {
  const NetworkEvent_VoiceChannelJoined({required this.serverId, required this.channelId, required this.peerId, required this.isSelf}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_VoiceChannelJoined&&(identical(other.serverId, serverId) || other.serverId == serverId)&&(identical(other.channelId, channelId) || other.channelId == channelId)&&(identical(other.peerId, peerId) || other.peerId == peerId)&&(identical(other.isSelf, isSelf) || other.isSelf == isSelf));
}


@override
int get hashCode => Object.hash(runtimeType,serverId,channelId,peerId,isSelf);

@override
String toString() {
  return 'NetworkEvent.voiceChannelJoined(serverId: $serverId, channelId: $channelId, peerId: $peerId, isSelf: $isSelf)';
}
...
@useResult
$Res call({
 String serverId, String channelId, String peerId, bool isSelf
});
...
/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? serverId = null,Object? channelId = null,Object? peerId = null,Object? isSelf = null,}) {
...
class NetworkEvent_VoiceChannelLeft extends NetworkEvent {
  const NetworkEvent_VoiceChannelLeft({required this.serverId, required this.channelId, required this.peerId, required this.isSelf}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_VoiceChannelLeft&&(identical(other.serverId, serverId) || other.serverId == serverId)&&(identical(other.channelId, channelId) || other.channelId == channelId)&&(identical(other.peerId, peerId) || other.peerId == peerId)&&(identical(other.isSelf, isSelf) || other.isSelf == isSelf));
}
...
@override
String toString() {
  return 'NetworkEvent.voiceChannelLeft(serverId: $serverId, channelId: $channelId, peerId: $peerId, isSelf: $isSelf)';
}
...
class NetworkEvent_ForwarderSignal extends NetworkEvent {
  const NetworkEvent_ForwarderSignal({required this.fromPeer, required this.signalType, required this.payload}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_ForwarderSignalCopyWith<NetworkEvent_ForwarderSignal> get copyWith => _$NetworkEvent_ForwarderSignalCopyWithImpl<NetworkEvent_ForwarderSignal>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_ForwarderSignal&&(identical(other.fromPeer, fromPeer) || other.fromPeer == fromPeer)&&(identical(other.signalType, signalType) || other.signalType == signalType)&&(identical(other.payload, payload) || other.payload == payload));
}


@override
int get hashCode => Object.hash(runtimeType,fromPeer,signalType,payload);

@override
String toString() {
  return 'NetworkEvent.forwarderSignal(fromPeer: $fromPeer, signalType: $signalType, payload: $payload)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_ForwarderSignalCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_ForwarderSignalCopyWith(NetworkEvent_ForwarderSignal value, $Res Function(NetworkEvent_ForwarderSignal) _then) = _$NetworkEvent_ForwarderSignalCopyWithImpl;
@useResult
$Res call({
 String fromPeer, String signalType, String payload
});
...
/// @nodoc
class _$NetworkEvent_ForwarderSignalCopyWithImpl<$Res>
    implements $NetworkEvent_ForwarderSignalCopyWith<$Res> {
  _$NetworkEvent_ForwarderSignalCopyWithImpl(this._self, this._then);

  final NetworkEvent_ForwarderSignal _self;
  final $Res Function(NetworkEvent_ForwarderSignal) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? fromPeer = null,Object? signalType = null,Object? payload = null,}) {
  return _then(NetworkEvent_ForwarderSignal(
fromPeer: null == fromPeer ? _self.fromPeer : fromPeer // ignore: cast_nullable_to_non_nullable
as String,signalType: null == signalType ? _self.signalType : signalType // ignore: cast_nullable_to_non_nullable
as String,payload: null == payload ? _self.payload : payload // ignore: cast_nullable_to_non_nullable
as String,
...
class NetworkEvent_MediaForwarderInfo extends NetworkEvent {
  const NetworkEvent_MediaForwarderInfo({required this.peerId, required this.online}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_MediaForwarderInfoCopyWith<NetworkEvent_MediaForwarderInfo> get copyWith => _$NetworkEvent_MediaForwarderInfoCopyWithImpl<NetworkEvent_MediaForwarderInfo>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_MediaForwarderInfo&&(identical(other.peerId, peerId) || other.peerId == peerId)&&(identical(other.online, online) || other.online == online));
}


@override
int get hashCode => Object.hash(runtimeType,peerId,online);

@override
String toString() {
  return 'NetworkEvent.mediaForwarderInfo(peerId: $peerId, online: $online)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_MediaForwarderInfoCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_MediaForwarderInfoCopyWith(NetworkEvent_MediaForwarderInfo value, $Res Function(NetworkEvent_MediaForwarderInfo) _then) = _$NetworkEvent_MediaForwarderInfoCopyWithImpl;
@useResult
$Res call({
 String peerId, bool online
});
...
/// @nodoc
class _$NetworkEvent_MediaForwarderInfoCopyWithImpl<$Res>
    implements $NetworkEvent_MediaForwarderInfoCopyWith<$Res> {
  _$NetworkEvent_MediaForwarderInfoCopyWithImpl(this._self, this._then);

  final NetworkEvent_MediaForwarderInfo _self;
  final $Res Function(NetworkEvent_MediaForwarderInfo) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? peerId = null,Object? online = null,}) {
  return _then(NetworkEvent_MediaForwarderInfo(
peerId: null == peerId ? _self.peerId : peerId // ignore: cast_nullable_to_non_nullable
as String,online: null == online ? _self.online : online // ignore: cast_nullable_to_non_nullable
as bool,
  ));
...
class NetworkEvent_GossipRelayOp extends NetworkEvent {
  const NetworkEvent_GossipRelayOp({required final  List<String> targets, required this.payload}): _targets = targets,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_GossipRelayOpCopyWith<NetworkEvent_GossipRelayOp> get copyWith => _$NetworkEvent_GossipRelayOpCopyWithImpl<NetworkEvent_GossipRelayOp>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_GossipRelayOp&&const DeepCollectionEquality().equals(other._targets, _targets)&&const DeepCollectionEquality().equals(other.payload, payload));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_targets),const DeepCollectionEquality().hash(payload));

@override
String toString() {
  return 'NetworkEvent.gossipRelayOp(targets: $targets, payload: $payload)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_GossipRelayOpCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_GossipRelayOpCopyWith(NetworkEvent_GossipRelayOp value, $Res Function(NetworkEvent_GossipRelayOp) _then) = _$NetworkEvent_GossipRelayOpCopyWithImpl;
@useResult
$Res call({
 List<String> targets, Uint8List payload
});
...
/// @nodoc
class _$NetworkEvent_GossipRelayOpCopyWithImpl<$Res>
    implements $NetworkEvent_GossipRelayOpCopyWith<$Res> {
  _$NetworkEvent_GossipRelayOpCopyWithImpl(this._self, this._then);

  final NetworkEvent_GossipRelayOp _self;
  final $Res Function(NetworkEvent_GossipRelayOp) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? targets = null,Object? payload = null,}) {
  return _then(NetworkEvent_GossipRelayOp(
targets: null == targets ? _self._targets : targets // ignore: cast_nullable_to_non_nullable
as List<String>,payload: null == payload ? _self.payload : payload // ignore: cast_nullable_to_non_nullable
as Uint8List,
  ));
}
...
class NetworkEvent_MlsEpochChanged extends NetworkEvent {
  const NetworkEvent_MlsEpochChanged({required this.serverId, required this.epoch, required this.sframeKey, this.channelId}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_MlsEpochChanged&&(identical(other.serverId, serverId) || other.serverId == serverId)&&(identical(other.epoch, epoch) || other.epoch == epoch)&&const DeepCollectionEquality().equals(other.sframeKey, sframeKey)&&(identical(other.channelId, channelId) || other.channelId == channelId));
}


@override
int get hashCode => Object.hash(runtimeType,serverId,epoch,const DeepCollectionEquality().hash(sframeKey),channelId);

@override
String toString() {
  return 'NetworkEvent.mlsEpochChanged(serverId: $serverId, epoch: $epoch, sframeKey: $sframeKey, channelId: $channelId)';
}
...
@useResult
$Res call({
 String serverId, BigInt epoch, Uint8List sframeKey, String? channelId
});
...
/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? serverId = null,Object? epoch = null,Object? sframeKey = null,Object? channelId = freezed,}) {
...
as Uint8List,channelId: freezed == channelId ? _self.channelId : channelId // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
class NetworkEvent_ConferenceJoinRequestReceived extends NetworkEvent {
  const NetworkEvent_ConferenceJoinRequestReceived({required this.confId, required this.peerId, required this.displayName, required this.avatarHash}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_ConferenceJoinRequestReceivedCopyWith<NetworkEvent_ConferenceJoinRequestReceived> get copyWith => _$NetworkEvent_ConferenceJoinRequestReceivedCopyWithImpl<NetworkEvent_ConferenceJoinRequestReceived>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_ConferenceJoinRequestReceived&&(identical(other.confId, confId) || other.confId == confId)&&(identical(other.peerId, peerId) || other.peerId == peerId)&&(identical(other.displayName, displayName) || other.displayName == displayName)&&(identical(other.avatarHash, avatarHash) || other.avatarHash == avatarHash));
}


@override
int get hashCode => Object.hash(runtimeType,confId,peerId,displayName,avatarHash);

@override
String toString() {
  return 'NetworkEvent.conferenceJoinRequestReceived(confId: $confId, peerId: $peerId, displayName: $displayName, avatarHash: $avatarHash)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_ConferenceJoinRequestReceivedCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_ConferenceJoinRequestReceivedCopyWith(NetworkEvent_ConferenceJoinRequestReceived value, $Res Function(NetworkEvent_ConferenceJoinRequestReceived) _then) = _$NetworkEvent_ConferenceJoinRequestReceivedCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$NetworkEvent_ConferenceJoinRequestReceivedCopyWithImpl<$Res>
    implements $NetworkEvent_ConferenceJoinRequestReceivedCopyWith<$Res> {
  _$NetworkEvent_ConferenceJoinRequestReceivedCopyWithImpl(this._self, this._then);

  final NetworkEvent_ConferenceJoinRequestReceived _self;
  final $Res Function(NetworkEvent_ConferenceJoinRequestReceived) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? confId = null,Object? peerId = null,Object? displayName = null,Object? avatarHash = null,}) {
  return _then(NetworkEvent_ConferenceJoinRequestReceived(
confId: null == confId ? _self.confId : confId // ignore: cast_nullable_to_non_nullable
as String,peerId: null == peerId ? _self.peerId : peerId // ignore: cast_nullable_to_non_nullable
as String,displayName: null == displayName ? _self.displayName : displayName // ignore: cast_nullable_to_non_nullable
as String,avatarHash: null == avatarHash ? _self.avatarHash : avatarHash // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class NetworkEvent_ConferenceJoinDenied extends NetworkEvent {
  const NetworkEvent_ConferenceJoinDenied({required this.confId, required this.reason}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_ConferenceJoinDeniedCopyWith<NetworkEvent_ConferenceJoinDenied> get copyWith => _$NetworkEvent_ConferenceJoinDeniedCopyWithImpl<NetworkEvent_ConferenceJoinDenied>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_ConferenceJoinDenied&&(identical(other.confId, confId) || other.confId == confId)&&(identical(other.reason, reason) || other.reason == reason));
}


@override
int get hashCode => Object.hash(runtimeType,confId,reason);

@override
String toString() {
  return 'NetworkEvent.conferenceJoinDenied(confId: $confId, reason: $reason)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_ConferenceJoinDeniedCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_ConferenceJoinDeniedCopyWith(NetworkEvent_ConferenceJoinDenied value, $Res Function(NetworkEvent_ConferenceJoinDenied) _then) = _$NetworkEvent_ConferenceJoinDeniedCopyWithImpl;
@useResult
$Res call({
 String confId, String reason
});
...
/// @nodoc
class _$NetworkEvent_ConferenceJoinDeniedCopyWithImpl<$Res>
    implements $NetworkEvent_ConferenceJoinDeniedCopyWith<$Res> {
  _$NetworkEvent_ConferenceJoinDeniedCopyWithImpl(this._self, this._then);

  final NetworkEvent_ConferenceJoinDenied _self;
  final $Res Function(NetworkEvent_ConferenceJoinDenied) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? confId = null,Object? reason = null,}) {
  return _then(NetworkEvent_ConferenceJoinDenied(
confId: null == confId ? _self.confId : confId // ignore: cast_nullable_to_non_nullable
as String,reason: null == reason ? _self.reason : reason // ignore: cast_nullable_to_non_nullable
as String,
  ));
...
class NetworkEvent_ConferenceLobbyInfo extends NetworkEvent {
  const NetworkEvent_ConferenceLobbyInfo({required this.confId, required this.hostPeerId, required this.hostName, required this.hostAvatarHash}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_ConferenceLobbyInfoCopyWith<NetworkEvent_ConferenceLobbyInfo> get copyWith => _$NetworkEvent_ConferenceLobbyInfoCopyWithImpl<NetworkEvent_ConferenceLobbyInfo>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_ConferenceLobbyInfo&&(identical(other.confId, confId) || other.confId == confId)&&(identical(other.hostPeerId, hostPeerId) || other.hostPeerId == hostPeerId)&&(identical(other.hostName, hostName) || other.hostName == hostName)&&(identical(other.hostAvatarHash, hostAvatarHash) || other.hostAvatarHash == hostAvatarHash));
}


@override
int get hashCode => Object.hash(runtimeType,confId,hostPeerId,hostName,hostAvatarHash);

@override
String toString() {
  return 'NetworkEvent.conferenceLobbyInfo(confId: $confId, hostPeerId: $hostPeerId, hostName: $hostName, hostAvatarHash: $hostAvatarHash)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_ConferenceLobbyInfoCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_ConferenceLobbyInfoCopyWith(NetworkEvent_ConferenceLobbyInfo value, $Res Function(NetworkEvent_ConferenceLobbyInfo) _then) = _$NetworkEvent_ConferenceLobbyInfoCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$NetworkEvent_ConferenceLobbyInfoCopyWithImpl<$Res>
    implements $NetworkEvent_ConferenceLobbyInfoCopyWith<$Res> {
  _$NetworkEvent_ConferenceLobbyInfoCopyWithImpl(this._self, this._then);

  final NetworkEvent_ConferenceLobbyInfo _self;
  final $Res Function(NetworkEvent_ConferenceLobbyInfo) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? confId = null,Object? hostPeerId = null,Object? hostName = null,Object? hostAvatarHash = null,}) {
  return _then(NetworkEvent_ConferenceLobbyInfo(
confId: null == confId ? _self.confId : confId // ignore: cast_nullable_to_non_nullable
as String,hostPeerId: null == hostPeerId ? _self.hostPeerId : hostPeerId // ignore: cast_nullable_to_non_nullable
as String,hostName: null == hostName ? _self.hostName : hostName // ignore: cast_nullable_to_non_nullable
as String,hostAvatarHash: null == hostAvatarHash ? _self.hostAvatarHash : hostAvatarHash // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class NetworkEvent_ConferenceAdmitted extends NetworkEvent {
  const NetworkEvent_ConferenceAdmitted({required this.confId}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_ConferenceAdmittedCopyWith<NetworkEvent_ConferenceAdmitted> get copyWith => _$NetworkEvent_ConferenceAdmittedCopyWithImpl<NetworkEvent_ConferenceAdmitted>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_ConferenceAdmitted&&(identical(other.confId, confId) || other.confId == confId));
}


@override
int get hashCode => Object.hash(runtimeType,confId);

@override
String toString() {
  return 'NetworkEvent.conferenceAdmitted(confId: $confId)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_ConferenceAdmittedCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_ConferenceAdmittedCopyWith(NetworkEvent_ConferenceAdmitted value, $Res Function(NetworkEvent_ConferenceAdmitted) _then) = _$NetworkEvent_ConferenceAdmittedCopyWithImpl;
@useResult
$Res call({
 String confId
});
...
/// @nodoc
class _$NetworkEvent_ConferenceAdmittedCopyWithImpl<$Res>
    implements $NetworkEvent_ConferenceAdmittedCopyWith<$Res> {
  _$NetworkEvent_ConferenceAdmittedCopyWithImpl(this._self, this._then);

  final NetworkEvent_ConferenceAdmitted _self;
  final $Res Function(NetworkEvent_ConferenceAdmitted) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? confId = null,}) {
  return _then(NetworkEvent_ConferenceAdmitted(
confId: null == confId ? _self.confId : confId // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class NetworkEvent_ConferenceChatMessage extends NetworkEvent {
  const NetworkEvent_ConferenceChatMessage({required this.confId, required this.senderPeerId, required this.text, required this.timestamp}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_ConferenceChatMessageCopyWith<NetworkEvent_ConferenceChatMessage> get copyWith => _$NetworkEvent_ConferenceChatMessageCopyWithImpl<NetworkEvent_ConferenceChatMessage>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_ConferenceChatMessage&&(identical(other.confId, confId) || other.confId == confId)&&(identical(other.senderPeerId, senderPeerId) || other.senderPeerId == senderPeerId)&&(identical(other.text, text) || other.text == text)&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp));
}


@override
int get hashCode => Object.hash(runtimeType,confId,senderPeerId,text,timestamp);

@override
String toString() {
  return 'NetworkEvent.conferenceChatMessage(confId: $confId, senderPeerId: $senderPeerId, text: $text, timestamp: $timestamp)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_ConferenceChatMessageCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_ConferenceChatMessageCopyWith(NetworkEvent_ConferenceChatMessage value, $Res Function(NetworkEvent_ConferenceChatMessage) _then) = _$NetworkEvent_ConferenceChatMessageCopyWithImpl;
@useResult
$Res call({
 String confId, String senderPeerId, String text, PlatformInt64 timestamp
});
...
/// @nodoc
class _$NetworkEvent_ConferenceChatMessageCopyWithImpl<$Res>
    implements $NetworkEvent_ConferenceChatMessageCopyWith<$Res> {
  _$NetworkEvent_ConferenceChatMessageCopyWithImpl(this._self, this._then);

  final NetworkEvent_ConferenceChatMessage _self;
  final $Res Function(NetworkEvent_ConferenceChatMessage) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? confId = null,Object? senderPeerId = null,Object? text = null,Object? timestamp = null,}) {
  return _then(NetworkEvent_ConferenceChatMessage(
confId: null == confId ? _self.confId : confId // ignore: cast_nullable_to_non_nullable
as String,senderPeerId: null == senderPeerId ? _self.senderPeerId : senderPeerId // ignore: cast_nullable_to_non_nullable
as String,text: null == text ? _self.text : text // ignore: cast_nullable_to_non_nullable
as String,timestamp: null == timestamp ? _self.timestamp : timestamp // ignore: cast_nullable_to_non_nullable
as PlatformInt64,
  ));
...
class NetworkEvent_ConferenceEnded extends NetworkEvent {
  const NetworkEvent_ConferenceEnded({required this.confId, required this.byPeerId}): super._();
  

 final  String confId;
 final  String byPeerId;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_ConferenceEndedCopyWith<NetworkEvent_ConferenceEnded> get copyWith => _$NetworkEvent_ConferenceEndedCopyWithImpl<NetworkEvent_ConferenceEnded>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_ConferenceEnded&&(identical(other.confId, confId) || other.confId == confId)&&(identical(other.byPeerId, byPeerId) || other.byPeerId == byPeerId));
}


@override
int get hashCode => Object.hash(runtimeType,confId,byPeerId);

@override
String toString() {
  return 'NetworkEvent.conferenceEnded(confId: $confId, byPeerId: $byPeerId)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_ConferenceEndedCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_ConferenceEndedCopyWith(NetworkEvent_ConferenceEnded value, $Res Function(NetworkEvent_ConferenceEnded) _then) = _$NetworkEvent_ConferenceEndedCopyWithImpl;
@useResult
$Res call({
 String confId, String byPeerId
});
...
/// @nodoc
class _$NetworkEvent_ConferenceEndedCopyWithImpl<$Res>
    implements $NetworkEvent_ConferenceEndedCopyWith<$Res> {
  _$NetworkEvent_ConferenceEndedCopyWithImpl(this._self, this._then);

  final NetworkEvent_ConferenceEnded _self;
  final $Res Function(NetworkEvent_ConferenceEnded) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? confId = null,Object? byPeerId = null,}) {
  return _then(NetworkEvent_ConferenceEnded(
confId: null == confId ? _self.confId : confId // ignore: cast_nullable_to_non_nullable
as String,byPeerId: null == byPeerId ? _self.byPeerId : byPeerId // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class NetworkEvent_ConferenceKicked extends NetworkEvent {
  const NetworkEvent_ConferenceKicked({required this.confId, required this.byPeerId}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_ConferenceKickedCopyWith<NetworkEvent_ConferenceKicked> get copyWith => _$NetworkEvent_ConferenceKickedCopyWithImpl<NetworkEvent_ConferenceKicked>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_ConferenceKicked&&(identical(other.confId, confId) || other.confId == confId)&&(identical(other.byPeerId, byPeerId) || other.byPeerId == byPeerId));
}
...
@override
String toString() {
  return 'NetworkEvent.conferenceKicked(confId: $confId, byPeerId: $byPeerId)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_ConferenceKickedCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_ConferenceKickedCopyWith(NetworkEvent_ConferenceKicked value, $Res Function(NetworkEvent_ConferenceKicked) _then) = _$NetworkEvent_ConferenceKickedCopyWithImpl;
@useResult
$Res call({
 String confId, String byPeerId
});
...
/// @nodoc
class _$NetworkEvent_ConferenceKickedCopyWithImpl<$Res>
    implements $NetworkEvent_ConferenceKickedCopyWith<$Res> {
  _$NetworkEvent_ConferenceKickedCopyWithImpl(this._self, this._then);

  final NetworkEvent_ConferenceKicked _self;
  final $Res Function(NetworkEvent_ConferenceKicked) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? confId = null,Object? byPeerId = null,}) {
  return _then(NetworkEvent_ConferenceKicked(
confId: null == confId ? _self.confId : confId // ignore: cast_nullable_to_non_nullable
as String,byPeerId: null == byPeerId ? _self.byPeerId : byPeerId // ignore: cast_nullable_to_non_nullable
as String,
  ));
...
class NetworkEvent_PublicChannelListReceived extends NetworkEvent {
  const NetworkEvent_PublicChannelListReceived({required this.serverId, required this.serverName, required final  List<PublicChannelEntryFfi> channels, this.serverAvatar, this.serverBannerThumb}): _channels = channels,super._();
 ...
 final  Uint8List? serverBannerThumb;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_PublicChannelListReceived&&(identical(other.serverId, serverId) || other.serverId == serverId)&&(identical(other.serverName, serverName) || other.serverName == serverName)&&const DeepCollectionEquality().equals(other._channels, _channels)&&const DeepCollectionEquality().equals(other.serverAvatar, serverAvatar)&&const DeepCollectionEquality().equals(other.serverBannerThumb, serverBannerThumb));
}


@override
int get hashCode => Object.hash(runtimeType,serverId,serverName,const DeepCollectionEquality().hash(_channels),const DeepCollectionEquality().hash(serverAvatar),const DeepCollectionEquality().hash(serverBannerThumb));

@override
String toString() {
  return 'NetworkEvent.publicChannelListReceived(serverId: $serverId, serverName: $serverName, channels: $channels, serverAvatar: $serverAvatar, serverBannerThumb: $serverBannerThumb)';
}
...
@useResult
$Res call({
 String serverId, String serverName, List<PublicChannelEntryFfi> channels, Uint8List? serverAvatar, Uint8List? serverBannerThumb
});
...
/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? serverId = null,Object? serverName = null,Object? channels = null,Object? serverAvatar = freezed,Object? serverBannerThumb = freezed,}) {
...
as Uint8List?,serverBannerThumb: freezed == serverBannerThumb ? _self.serverBannerThumb : serverBannerThumb // ignore: cast_nullable_to_non_nullable
as Uint8List?,
  ));
}
