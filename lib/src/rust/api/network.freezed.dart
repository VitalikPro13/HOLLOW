...
return messageReceived(_that.fromPeer,_that.text,_that.timestamp,_that.messageId,_that.replyToMid,_that.linkPreview,_that.signature,_that.publicKey,_that.isOwn,_that.duplicate);case NetworkEvent_ChannelMessageReceived() when channelMessageReceived != null:
return channelMessageReceived(_that.serverId,_that.channelId,_that.fromPeer,_that.text,_that.timestamp,_that.messageId,_that.replyToMid,_that.linkPreview,_that.signature,_that.publicKey,_that.replyToOwn,_that.duplicate,_that.isOwn);case NetworkEvent_MessageSent() when messageSent != null:
...
return messageReceived(_that.fromPeer,_that.text,_that.timestamp,_that.messageId,_that.replyToMid,_that.linkPreview,_that.signature,_that.publicKey,_that.isOwn,_that.duplicate);case NetworkEvent_ChannelMessageReceived():
return channelMessageReceived(_that.serverId,_that.channelId,_that.fromPeer,_that.text,_that.timestamp,_that.messageId,_that.replyToMid,_that.linkPreview,_that.signature,_that.publicKey,_that.replyToOwn,_that.duplicate,_that.isOwn);case NetworkEvent_MessageSent():
...
class NetworkEvent_MessageReceived extends NetworkEvent {
  const NetworkEvent_MessageReceived({required this.fromPeer, required this.text, required this.timestamp, required this.messageId, required this.replyToMid, this.linkPreview, this.signature, this.publicKey, required this.isOwn, required this.duplicate}): super._();
...
@override
int get hashCode => Object.hash(runtimeType,fromPeer,text,timestamp,messageId,replyToMid,linkPreview,signature,publicKey,isOwn,duplicate);

@override
String toString() {
  return 'NetworkEvent.messageReceived(fromPeer: $fromPeer, text: $text, timestamp: $timestamp, messageId: $messageId, replyToMid: $replyToMid, linkPreview: $linkPreview, signature: $signature, publicKey: $publicKey, isOwn: $isOwn, duplicate: $duplicate)';
}
...
@useResult
$Res call({
 String fromPeer, String text, PlatformInt64 timestamp, String messageId, String replyToMid, LinkPreviewRef? linkPreview, String? signature, String? publicKey, bool isOwn, bool duplicate
});
...
/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? fromPeer = null,Object? text = null,Object? timestamp = null,Object? messageId = null,Object? replyToMid = null,Object? linkPreview = freezed,Object? signature = freezed,Object? publicKey = freezed,Object? isOwn = null,Object? duplicate = null,}) {
...
@override
int get hashCode => Object.hash(runtimeType,serverId,channelId,fromPeer,text,timestamp,messageId,replyToMid,linkPreview,signature,publicKey,replyToOwn,duplicate,isOwn);

@override
String toString() {
  return 'NetworkEvent.channelMessageReceived(serverId: $serverId, channelId: $channelId, fromPeer: $fromPeer, text: $text, timestamp: $timestamp, messageId: $messageId, replyToMid: $replyToMid, linkPreview: $linkPreview, signature: $signature, publicKey: $publicKey, replyToOwn: $replyToOwn, duplicate: $duplicate, isOwn: $isOwn)';
}
...
@useResult
$Res call({
 String serverId, String channelId, String fromPeer, String text, PlatformInt64 timestamp, String messageId, String replyToMid, LinkPreviewRef? linkPreview, String? signature, String? publicKey, bool replyToOwn, bool duplicate, bool isOwn
});
...
/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? serverId = null,Object? channelId = null,Object? fromPeer = null,Object? text = null,Object? timestamp = null,Object? messageId = null,Object? replyToMid = null,Object? linkPreview = freezed,Object? signature = freezed,Object? publicKey = freezed,Object? replyToOwn = null,Object? duplicate = null,Object? isOwn = null,}) {
