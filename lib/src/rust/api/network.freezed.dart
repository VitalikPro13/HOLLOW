...
return deviceListUpdated(_that);case NetworkEvent_SecurityAlert() when securityAlert != null:
...
return deviceListUpdated(_that);case NetworkEvent_SecurityAlert():
...
return channelMessageReceived(_that.serverId,_that.channelId,_that.fromPeer,_that.text,_that.timestamp,_that.messageId,_that.replyToMid,_that.linkPreview,_that.signature,_that.publicKey,_that.replyToOwn,_that.duplicate);case NetworkEvent_MessageSent() when messageSent != null:
...
return deviceListUpdated(_that.masterPeerId);case NetworkEvent_SecurityAlert() when securityAlert != null:
...
return channelMessageReceived(_that.serverId,_that.channelId,_that.fromPeer,_that.text,_that.timestamp,_that.messageId,_that.replyToMid,_that.linkPreview,_that.signature,_that.publicKey,_that.replyToOwn,_that.duplicate);case NetworkEvent_MessageSent():
...
return deviceListUpdated(_that.masterPeerId);case NetworkEvent_SecurityAlert():
...
@override
int get hashCode => Object.hash(runtimeType,serverId,channelId,fromPeer,text,timestamp,messageId,replyToMid,linkPreview,signature,publicKey,replyToOwn,duplicate);

@override
String toString() {
  return 'NetworkEvent.channelMessageReceived(serverId: $serverId, channelId: $channelId, fromPeer: $fromPeer, text: $text, timestamp: $timestamp, messageId: $messageId, replyToMid: $replyToMid, linkPreview: $linkPreview, signature: $signature, publicKey: $publicKey, replyToOwn: $replyToOwn, duplicate: $duplicate)';
}
...
@useResult
$Res call({
 String serverId, String channelId, String fromPeer, String text, PlatformInt64 timestamp, String messageId, String replyToMid, LinkPreviewRef? linkPreview, String? signature, String? publicKey, bool replyToOwn, bool duplicate
});
...
/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? serverId = null,Object? channelId = null,Object? fromPeer = null,Object? text = null,Object? timestamp = null,Object? messageId = null,Object? replyToMid = null,Object? linkPreview = freezed,Object? signature = freezed,Object? publicKey = freezed,Object? replyToOwn = null,Object? duplicate = null,}) {
