...
return relayConnecting(_that);case NetworkEvent_BandwidthStatus() when bandwidthStatus != null:
return bandwidthStatus(_that);case NetworkEvent_BandwidthLimited() when bandwidthLimited != null:
return bandwidthLimited(_that);case NetworkEvent_ChannelNotificationHint() when channelNotificationHint != null:
...
return relayConnecting(_that);case NetworkEvent_BandwidthStatus():
return bandwidthStatus(_that);case NetworkEvent_BandwidthLimited():
return bandwidthLimited(_that);case NetworkEvent_ChannelNotificationHint():
...
return relayConnecting(_that.reconnecting);case NetworkEvent_BandwidthStatus() when bandwidthStatus != null:
return bandwidthStatus(_that.usedBytes,_that.budgetBytes,_that.resetInSecs);case NetworkEvent_BandwidthLimited() when bandwidthLimited != null:
return bandwidthLimited();case NetworkEvent_ChannelNotificationHint() when channelNotificationHint != null:
...
return relayConnecting(_that.reconnecting);case NetworkEvent_BandwidthStatus():
return bandwidthStatus(_that.usedBytes,_that.budgetBytes,_that.resetInSecs);case NetworkEvent_BandwidthLimited():
return bandwidthLimited();case NetworkEvent_ChannelNotificationHint():
...
class NetworkEvent_BandwidthStatus extends NetworkEvent {
  const NetworkEvent_BandwidthStatus({required this.usedBytes, required this.budgetBytes, required this.resetInSecs}): super._();
  

 final  BigInt usedBytes;
 final  BigInt budgetBytes;
 final  BigInt resetInSecs;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NetworkEvent_BandwidthStatusCopyWith<NetworkEvent_BandwidthStatus> get copyWith => _$NetworkEvent_BandwidthStatusCopyWithImpl<NetworkEvent_BandwidthStatus>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_BandwidthStatus&&(identical(other.usedBytes, usedBytes) || other.usedBytes == usedBytes)&&(identical(other.budgetBytes, budgetBytes) || other.budgetBytes == budgetBytes)&&(identical(other.resetInSecs, resetInSecs) || other.resetInSecs == resetInSecs));
}


@override
int get hashCode => Object.hash(runtimeType,usedBytes,budgetBytes,resetInSecs);

@override
String toString() {
  return 'NetworkEvent.bandwidthStatus(usedBytes: $usedBytes, budgetBytes: $budgetBytes, resetInSecs: $resetInSecs)';
}
...
/// @nodoc
abstract mixin class $NetworkEvent_BandwidthStatusCopyWith<$Res> implements $NetworkEventCopyWith<$Res> {
  factory $NetworkEvent_BandwidthStatusCopyWith(NetworkEvent_BandwidthStatus value, $Res Function(NetworkEvent_BandwidthStatus) _then) = _$NetworkEvent_BandwidthStatusCopyWithImpl;
@useResult
$Res call({
 BigInt usedBytes, BigInt budgetBytes, BigInt resetInSecs
});
...
/// @nodoc
class _$NetworkEvent_BandwidthStatusCopyWithImpl<$Res>
    implements $NetworkEvent_BandwidthStatusCopyWith<$Res> {
  _$NetworkEvent_BandwidthStatusCopyWithImpl(this._self, this._then);

  final NetworkEvent_BandwidthStatus _self;
  final $Res Function(NetworkEvent_BandwidthStatus) _then;

/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? usedBytes = null,Object? budgetBytes = null,Object? resetInSecs = null,}) {
  return _then(NetworkEvent_BandwidthStatus(
usedBytes: null == usedBytes ? _self.usedBytes : usedBytes // ignore: cast_nullable_to_non_nullable
as BigInt,budgetBytes: null == budgetBytes ? _self.budgetBytes : budgetBytes // ignore: cast_nullable_to_non_nullable
as BigInt,resetInSecs: null == resetInSecs ? _self.resetInSecs : resetInSecs // ignore: cast_nullable_to_non_nullable
as BigInt,
  ));
}
...
class NetworkEvent_BandwidthLimited extends NetworkEvent {
  const NetworkEvent_BandwidthLimited(): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NetworkEvent_BandwidthLimited);
}
...
@override
String toString() {
  return 'NetworkEvent.bandwidthLimited()';
}
