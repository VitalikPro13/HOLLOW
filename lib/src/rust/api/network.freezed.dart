...
return messageReceived(_that.fromPeer,_that.text,_that.timestamp,_that.messageId,_that.replyToMid,_that.linkPreview,_that.signature,_that.publicKey,_that.isOwn);case NetworkEvent_ChannelMessageReceived() when channelMessageReceived != null:
...
return messageReceived(_that.fromPeer,_that.text,_that.timestamp,_that.messageId,_that.replyToMid,_that.linkPreview,_that.signature,_that.publicKey,_that.isOwn);case NetworkEvent_ChannelMessageReceived():
...
class NetworkEvent_MessageReceived extends NetworkEvent {
  const NetworkEvent_MessageReceived({required this.fromPeer, required this.text, required this.timestamp, required this.messageId, required this.replyToMid, this.linkPreview, this.signature, this.publicKey, required this.isOwn}): super._();
...
@override
int get hashCode => Object.hash(runtimeType,fromPeer,text,timestamp,messageId,replyToMid,linkPreview,signature,publicKey,isOwn);

@override
String toString() {
  return 'NetworkEvent.messageReceived(fromPeer: $fromPeer, text: $text, timestamp: $timestamp, messageId: $messageId, replyToMid: $replyToMid, linkPreview: $linkPreview, signature: $signature, publicKey: $publicKey, isOwn: $isOwn)';
}
...
@useResult
$Res call({
 String fromPeer, String text, PlatformInt64 timestamp, String messageId, String replyToMid, LinkPreviewRef? linkPreview, String? signature, String? publicKey, bool isOwn
});
...
/// Create a copy of NetworkEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? fromPeer = null,Object? text = null,Object? timestamp = null,Object? messageId = null,Object? replyToMid = null,Object? linkPreview = freezed,Object? signature = freezed,Object? publicKey = freezed,Object? isOwn = null,}) {
