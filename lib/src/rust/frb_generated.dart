...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1287105929;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<StoredGif> crateApiGifsGifFetchAndStore({required String id});
  ...
  Future<GifPage> crateApiGifsGifTrending({required int page});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  TaskConstMeta get kCrateApiGifsGifFetchAndStoreConstMeta =>
      const TaskConstMeta(debugName: "gif_fetch_and_store", argNames: ["id"]);
  ...
  TaskConstMeta get kCrateApiGifsGifSearchConstMeta =>
      const TaskConstMeta(debugName: "gif_search", argNames: ["query", "page"]);
  ...
  TaskConstMeta get kCrateApiGifsGifTrendingConstMeta =>
      const TaskConstMeta(debugName: "gif_trending", argNames: ["page"]);
