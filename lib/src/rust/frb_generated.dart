...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1211665074;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<BigInt> crateApiStorageEnforceStorageCaps({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        argValues: [filesCapMb, vaultCacheCapMb, exemptPaths],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta get kCrateApiStorageEnforceStorageCapsConstMeta =>
      const TaskConstMeta(
        ...
        argNames: ["filesCapMb", "vaultCacheCapMb", "exemptPaths"],
      );
  ...
  StorageBreakdown dco_decode_storage_breakdown(dynamic raw) {
    ...
    return StorageBreakdown(
      ...
      contexts: dco_decode_list_storage_context_usage(arr[4]),
    );
  }
