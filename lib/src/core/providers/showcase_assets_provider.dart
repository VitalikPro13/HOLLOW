...
/// The replicated showcase assets (game covers, artwork) for a peer's profile,
/// keyed by content hash. Pure local read: the bundle arrived via profile
/// replication, and viewers never fetch anything.
