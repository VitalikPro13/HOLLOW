...
- **`.hollowpack` (artist shop):** identity = sha256 of PROCESSED bytes; the `hollowpack` CLI runs the app's own encoders; `import_hollowpack` verifies caps/hashes/dims/frame centre and NEVER re-encodes. wiki `hollowpack`.
