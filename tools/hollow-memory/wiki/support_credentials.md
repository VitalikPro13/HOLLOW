...
The Creem rail (product, checkout, license keys, split, refund webhooks) is gone from `anonlisten-sites/shop`; plan and contract in `reports/planned/shop/KOFI_SHOP_PLAN.md`, memory `project_shop_kofi_code_model`.
