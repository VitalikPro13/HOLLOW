...
`:` shortcode autocomplete in composers (channel pane mention overlay = template); stickers (same stack, bigger caps, standalone render); mobile server-emote management UI; personal-emote sibling sync.
