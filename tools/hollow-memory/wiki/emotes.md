...
- **`ui/server_settings/pages/emotes_page.dart`** — server settings "Emotes and stickers" page (view for all, add/remove gated on `Permission.manageEmotes`, 50 cap, removal confirms); desktop and phone.
