...
- **VoiceChannelPane.hideChatOverlay** (default false, 2026-09-25): skips BOTH chat drawer blocks; the conference hosts its chat in its own single side panel instead.
