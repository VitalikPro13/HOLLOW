...
- [ ] Weird slow loading at the start on mobile as if connecting but it should show all the list from local DB rather than loading. probably the same issue on desktop too but I didn't see it
